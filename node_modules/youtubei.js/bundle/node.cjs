...
function deepCompare(obj1, obj2) {
  ...
  return keys.some((key) => {
    var _b2;
    const is_text = ((_b2 = obj2[key]) === null || _b2 === void 0 ? void 0 : _b2.constructor.name) === "Text";
...
var CustomEvent = class extends Event {
  constructor(type, options) {
    ...
    __classPrivateFieldSet3(this, _CustomEvent_detail, (_a7 = options === null || options === void 0 ? void 0 : options.detail) !== null && _a7 !== void 0 ? _a7 : null, "f");
  }
  get detail() {
...
var EventEmitterLike = class extends EventTarget {
  ...
  on(type, listener) {
    ...
    __classPrivateFieldGet4(this, _EventEmitterLike_legacy_listeners, "f").set(listener, wrapper);
  ...
  off(type, listener) {
    const wrapper = __classPrivateFieldGet4(this, _EventEmitterLike_legacy_listeners, "f").get(listener);
    if (wrapper) {
      this.removeEventListener(type, wrapper);
      __classPrivateFieldGet4(this, _EventEmitterLike_legacy_listeners, "f").delete(listener);
    }
  }
};
...
var Button = class extends YTNode {
  constructor(data) {
    ...
    if ((_a7 = data.accessibility) === null || _a7 === void 0 ? void 0 : _a7.label) {
      this.label = (_b2 = data.accessibility) === null || _b2 === void 0 ? void 0 : _b2.label;
    }
    if (data.tooltip) {
...
var DropdownItem = class extends YTNode {
  constructor(data) {
    ...
    if ((_a7 = data.onSelectCommand) === null || _a7 === void 0 ? void 0 : _a7.browseEndpoint) {
      this.endpoint = new NavigationEndpoint_default(data.onSelectCommand);
    }
    if ((_b2 = data.icon) === null || _b2 === void 0 ? void 0 : _b2.iconType) {
...
var CreatePlaylistDialog = class extends YTNode {
  constructor(data) {
    ...
    this.privacy_option = ((_a7 = parser_default.parseItem(data.privacyOption, Dropdown_default)) === null || _a7 === void 0 ? void 0 : _a7.entries) || null;
...
var Menu = class extends YTNode {
  constructor(data) {
    ...
    this.label = ((_b2 = (_a7 = data.accessibility) === null || _a7 === void 0 ? void 0 : _a7.accessibilityData) === null || _b2 === void 0 ? void 0 : _b2.label) || null;
  }
  get contents() {
    return this.items;
  }
...
var SortFilterSubMenu = class extends YTNode {
  constructor(data) {
    ...
    if ((_a7 = data.icon) === null || _a7 === void 0 ? void 0 : _a7.iconType) {
      this.icon_type = data.icon.iconType;
    }
    if ((_c = (_b2 = data.accessibility) === null || _b2 === void 0 ? void 0 : _b2.accessibilityData) === null || _c === void 0 ? void 0 : _c.label) {
    ...
    if (data.subMenuItems) {
      this.sub_menu_items = data.subMenuItems.map((item) => {
        ...
        return {
          ...
          continuation: (_b3 = (_a8 = item.continuation) === null || _a8 === void 0 ? void 0 : _a8.reloadContinuationData) === null || _b3 === void 0 ? void 0 : _b3.continuation,
...
var MusicMultiSelectMenuItem = class extends YTNode {
  constructor(data) {
    ...
    this.selected_icon_type = ((_a7 = data.selectedIcon) === null || _a7 === void 0 ? void 0 : _a7.iconType) || null;
...
var Format = class {
  constructor(data) {
    ...
    if (this.has_audio) {
      ...
      this.language = ((_b2 = (_a7 = url_components.get("xtags")) === null || _a7 === void 0 ? void 0 : _a7.split(":").find((x) => x.startsWith("lang="))) === null || _b2 === void 0 ? void 0 : _b2.split("=").at(1)) || null;
...
var AnalyticsVodCarouselCard = class extends YTNode {
  constructor(data) {
    ...
    this.videos = ((_a7 = data.videoCarouselData) === null || _a7 === void 0 ? void 0 : _a7.videos.map((video) => new AnalyticsVideo_default(video))) || null;
  }
};
...
var Author = class {
  constructor(item, badges, thumbs, id) {
    ...
    __classPrivateFieldSet4(this, _Author_nav_text, new Text(item), "f");
    this.id = id || ((_e = (_d = (_c = (_b2 = (_a7 = __classPrivateFieldGet5(this, _Author_nav_text, "f")) === null || _a7 === void 0 ? void 0 : _a7.runs) === null || _b2 === void 0 ? void 0 : _b2[0]) === null || _c === void 0 ? void 0 : _c.endpoint) === null || _d === void 0 ? void 0 : _d.payload) === null || _e === void 0 ? void 0 : _e.browseId) || ((_h = (_g = (_f = __classPrivateFieldGet5(this, _Author_nav_text, "f")) === null || _f === void 0 ? void 0 : _f.endpoint) === null || _g === void 0 ? void 0 : _g.payload) === null || _h === void 0 ? void 0 : _h.browseId) || "N/A";
    this.name = ((_j = __classPrivateFieldGet5(this, _Author_nav_text, "f")) === null || _j === void 0 ? void 0 : _j.text) || "N/A";
    this.thumbnails = thumbs ? Thumbnail_default.fromResponse(thumbs) : [];
    this.endpoint = ((_m = (_l = (_k = __classPrivateFieldGet5(this, _Author_nav_text, "f")) === null || _k === void 0 ? void 0 : _k.runs) === null || _l === void 0 ? void 0 : _l[0]) === null || _m === void 0 ? void 0 : _m.endpoint) || ((_o = __classPrivateFieldGet5(this, _Author_nav_text, "f")) === null || _o === void 0 ? void 0 : _o.endpoint) || null;
    this.badges = Array.isArray(badges) ? parser_default.parseArray(badges) : observe([]);
    this.is_moderator = ((_p = this.badges) === null || _p === void 0 ? void 0 : _p.some((badge) => badge.icon_type == "MODERATOR")) || null;
    this.is_verified = ((_q = this.badges) === null || _q === void 0 ? void 0 : _q.some((badge) => badge.style == "BADGE_STYLE_TYPE_VERIFIED")) || null;
    this.is_verified_artist = ((_r = this.badges) === null || _r === void 0 ? void 0 : _r.some((badge) => badge.style == "BADGE_STYLE_TYPE_VERIFIED_ARTIST")) || null;
    this.url = ((_w = (_v = (_u = (_t = (_s = __classPrivateFieldGet5(this, _Author_nav_text, "f")) === null || _s === void 0 ? void 0 : _s.runs) === null || _t === void 0 ? void 0 : _t[0]) === null || _u === void 0 ? void 0 : _u.endpoint) === null || _v === void 0 ? void 0 : _v.metadata) === null || _w === void 0 ? void 0 : _w.api_url) === "/browse" && `${Constants_default.URLS.YT_BASE}${((_1 = (_0 = (_z = (_y = (_x = __classPrivateFieldGet5(this, _Author_nav_text, "f")) === null || _x === void 0 ? void 0 : _x.runs) === null || _y === void 0 ? void 0 : _y[0]) === null || _z === void 0 ? void 0 : _z.endpoint) === null || _0 === void 0 ? void 0 : _0.payload) === null || _1 === void 0 ? void 0 : _1.canonicalBaseUrl) || `/u/${(_6 = (_5 = (_4 = (_3 = (_2 = __classPrivateFieldGet5(this, _Author_nav_text, "f")) === null || _2 === void 0 ? void 0 : _2.runs) === null || _3 === void 0 ? void 0 : _3[0]) === null || _4 === void 0 ? void 0 : _4.endpoint) === null || _5 === void 0 ? void 0 : _5.payload) === null || _6 === void 0 ? void 0 : _6.browseId}`}` || `${Constants_default.URLS.YT_BASE}${((_9 = (_8 = (_7 = __classPrivateFieldGet5(this, _Author_nav_text, "f")) === null || _7 === void 0 ? void 0 : _7.endpoint) === null || _8 === void 0 ? void 0 : _8.payload) === null || _9 === void 0 ? void 0 : _9.canonicalBaseUrl) || `/u/${(_12 = (_11 = (_10 = __classPrivateFieldGet5(this, _Author_nav_text, "f")) === null || _10 === void 0 ? void 0 : _10.endpoint) === null || _11 === void 0 ? void 0 : _11.payload) === null || _12 === void 0 ? void 0 : _12.browseId}`}` || null;
  }
  get best_thumbnail() {
...
var CreatorHeart = class extends YTNode {
  constructor(data) {
    ...
    this.heart_icon_type = (_a7 = data.heartIcon) === null || _a7 === void 0 ? void 0 : _a7.iconType;
    this.heart_color = {
      basic_color_palette_data: {
        foreground_title_color: (_c = (_b2 = data.heartColor) === null || _b2 === void 0 ? void 0 : _b2.basicColorPaletteData) === null || _c === void 0 ? void 0 : _c.foregroundTitleColor
      }
    };
...
var ChannelHeaderLinks = class extends YTNode {
  constructor(data) {
    var _a7, _b2;
    super();
    this.primary = ((_a7 = data.primaryLinks) === null || _a7 === void 0 ? void 0 : _a7.map((link) => new HeaderLink(link))) || [];
    this.secondary = ((_b2 = data.secondaryLinks) === null || _b2 === void 0 ? void 0 : _b2.map((link) => new HeaderLink(link))) || [];
  }
};
...
var AuthorCommentBadge = class extends YTNode {
  constructor(data) {
    ...
    this.icon_type = ((_a7 = data.icon) === null || _a7 === void 0 ? void 0 : _a7.iconType) || null;
  ...
  get orig_badge() {
    return __classPrivateFieldGet6(this, _AuthorCommentBadge_data, "f");
  }
};
...
var Comment = class extends YTNode {
  ...
  like() {
    ...
    return __awaiter2(this, void 0, void 0, function* () {
      if (!__classPrivateFieldGet7(this, _Comment_actions, "f"))
      ...
      const response = yield button.endpoint.call(__classPrivateFieldGet7(this, _Comment_actions, "f"), { parse: false });
      return response;
    });
  }
  dislike() {
  ...
  reply(text) {
    ...
    return __awaiter2(this, void 0, void 0, function* () {
      ...
      const response = yield dialog_button.endpoint.call(__classPrivateFieldGet7(this, _Comment_actions, "f"), { commentText: text });
      return response;
    });
  }
  translate(target_language) {
    ...
    return __awaiter2(this, void 0, void 0, function* () {
      ...
      const response = yield __classPrivateFieldGet7(this, _Comment_actions, "f").execute("comment/perform_comment_action", { action, client: "ANDROID" });
...
var CommentsHeader = class extends YTNode {
  constructor(data) {
    ...
    this.custom_emojis = ((_a7 = data.customEmojis) === null || _a7 === void 0 ? void 0 : _a7.map((emoji) => ({
...
var CommentThread = class extends YTNode {
  ...
  getReplies() {
    ...
    return __awaiter3(this, void 0, void 0, function* () {
      if (!__classPrivateFieldGet8(this, _CommentThread_actions, "f"))
        throw new InnertubeError("Actions instance not set for this thread.");
      if (!this.comment_replies_data)
        throw new InnertubeError("This comment has no replies.", { comment_id: (_a7 = this.comment) === null || _a7 === void 0 ? void 0 : _a7.comment_id });
      const continuation = (_b2 = this.comment_replies_data.contents) === null || _b2 === void 0 ? void 0 : _b2.firstOfType(ContinuationItem_default);
      if (!continuation)
        throw new InnertubeError("Replies continuation not found.");
      const response = yield continuation.endpoint.call(__classPrivateFieldGet8(this, _CommentThread_actions, "f"), { parse: true });
      if (!response.on_response_received_endpoints_memo)
        throw new InnertubeError("Unexpected response.", response);
      this.replies = observe(response.on_response_received_endpoints_memo.getType(Comment_default).map((comment) => {
        comment.setActions(__classPrivateFieldGet8(this, _CommentThread_actions, "f"));
        return comment;
      }));
  ...
  getContinuation() {
    ...
    return __awaiter3(this, void 0, void 0, function* () {
      ...
      if (!__classPrivateFieldGet8(this, _CommentThread_continuation, "f"))
        throw new InnertubeError("Continuation not found.");
      if (!__classPrivateFieldGet8(this, _CommentThread_actions, "f"))
        throw new InnertubeError("Actions instance not set for this thread.");
      const load_more_button = (_a7 = __classPrivateFieldGet8(this, _CommentThread_continuation, "f").button) === null || _a7 === void 0 ? void 0 : _a7.as(Button_default);
      if (!load_more_button)
        throw new InnertubeError('"Load more" button not found.');
      const response = yield load_more_button.endpoint.call(__classPrivateFieldGet8(this, _CommentThread_actions, "f"), { parse: true });
      if (!response.on_response_received_endpoints_memo)
        throw new InnertubeError("Unexpected response.", response);
      this.replies = observe(response.on_response_received_endpoints_memo.getType(Comment_default).map((comment) => {
        comment.setActions(__classPrivateFieldGet8(this, _CommentThread_actions, "f"));
      ...
      __classPrivateFieldSet7(this, _CommentThread_continuation, (_b2 = response.on_response_received_endpoints_memo.getType(ContinuationItem_default)) === null || _b2 === void 0 ? void 0 : _b2[0], "f");
      return this;
    });
  }
  get has_continuation() {
    ...
    return !!__classPrivateFieldGet8(this, _CommentThread_continuation, "f");
  }
  setActions(actions) {
...
var ChildElement = class {
  constructor(data) {
    var _a7, _b2;
    this.text = ((_b2 = (_a7 = data.type.textType) === null || _a7 === void 0 ? void 0 : _a7.text) === null || _b2 === void 0 ? void 0 : _b2.content) || null;
...
var Element = class extends YTNode {
  constructor(data) {
    ...
    if ((_a7 = data.newElement) === null || _a7 === void 0 ? void 0 : _a7.childElements) {
      this.child_elements = ((_c = (_b2 = data.newElement) === null || _b2 === void 0 ? void 0 : _b2.childElements) === null || _c === void 0 ? void 0 : _c.map((el) => new ChildElement_default(el))) || null;
    }
  }
};
...
var Video = class extends YTNode {
  constructor(data) {
    ...
    this.snippets = ((_b2 = data.detailedMetadataSnippets) === null || _b2 === void 0 ? void 0 : _b2.map((snippet) => ({
...
var GridPlaylist = class extends YTNode {
  constructor(data) {
    ...
    this.sidebar_thumbnails = [].concat(...((_a7 = data.sidebarThumbnails) === null || _a7 === void 0 ? void 0 : _a7.map((thumbnail) => Thumbnail_default.fromResponse(thumbnail))) || []) || null;
    this.video_count = new Text(data.thumbnailText);
    this.video_count_short = new Text(data.videoCountShortText);
  }
};
...
var GridShow = class extends YTNode {
  constructor(data) {
    ...
    this.thumbnail_overlays = Parser.parseArray(data.thumbnailOverlays, ThumbnailOverlayBottomPanel_default);
...
var GridVideo = class extends YTNode {
  constructor(data) {
    ...
    this.thumbnails = Thumbnail_default.fromResponse(data.thumbnail);
    this.thumbnail_overlays = parser_default.parseArray(data.thumbnailOverlays);
    this.rich_thumbnail = data.richThumbnail && parser_default.parseItem(data.richThumbnail);
    this.published = new Text(data.publishedTimeText);
    this.duration = data.lengthText ? new Text(data.lengthText) : (length_alt === null || length_alt === void 0 ? void 0 : length_alt.text) ? new Text(length_alt.text) : null;
...
var InfoPanelContent = class extends YTNode {
  constructor(data) {
    ...
    if ((_a7 = data.inlineLinkIcon) === null || _a7 === void 0 ? void 0 : _a7.iconType) {
...
var InfoPanelContainer = class extends YTNode {
  constructor(data) {
    ...
    this.title = new Text(data.title);
    this.menu = parser_default.parseItem(data.menu, Menu_default);
    this.content = parser_default.parseItem(data.content, InfoPanelContent);
    this.background = data.background;
    if ((_a7 = data.icon) === null || _a7 === void 0 ? void 0 : _a7.iconType) {
      this.icon_type = data.icon.iconType;
    }
...
var LikeButton = class extends YTNode {
  constructor(data) {
    ...
    if (data.serviceEndpoints) {
      this.endpoints = (_a7 = data.serviceEndpoints) === null || _a7 === void 0 ? void 0 : _a7.map((endpoint) => new NavigationEndpoint_default(endpoint));
    }
  }
};
...
var LiveChatRestrictedParticipation = class extends YTNode {
  constructor(data) {
    ...
    super();
    this.message = new Text(data.message);
    this.icon_type = (_a7 = data === null || data === void 0 ? void 0 : data.icon) === null || _a7 === void 0 ? void 0 : _a7.iconType;
  }
};
...
var MusicMultiSelectMenu = class extends YTNode {
  constructor(data) {
    var _a7;
    super();
    this.title = new Text((_a7 = data.title.musicMenuTitleRenderer) === null || _a7 === void 0 ? void 0 : _a7.primaryText).toString();
...
var MovingThumbnail = class extends YTNode {
  constructor(data) {
    var _a7;
    super();
    return (_a7 = data.movingThumbnailDetails) === null || _a7 === void 0 ? void 0 : _a7.thumbnails.map((thumbnail) => new Thumbnail_default(thumbnail)).sort((a, b) => b.width - a.width);
  }
};
...
var MusicPlayButton = class extends YTNode {
  constructor(data) {
    ...
    if (data.accessibilityPlayData) {
      this.pause_label = (_a7 = data.accessibilityPauseData) === null || _a7 === void 0 ? void 0 : _a7.accessibilityData.label;
    }
...
var MusicCardShelf = class extends YTNode {
  constructor(data) {
    ...
    this.header = parser_default.parseItem(data.header, MusicCardShelfHeaderBasic);
...
var MusicResponsiveListItem = class extends YTNode {
  constructor(data) {
    ...
    switch (page_type) {
      case "MUSIC_PAGE_TYPE_ALBUM":
        this.item_type = "album";
        __classPrivateFieldGet9(this, _MusicResponsiveListItem_instances, "m", _MusicResponsiveListItem_parseAlbum).call(this);
        break;
      case "MUSIC_PAGE_TYPE_PLAYLIST":
        this.item_type = "playlist";
        __classPrivateFieldGet9(this, _MusicResponsiveListItem_instances, "m", _MusicResponsiveListItem_parsePlaylist).call(this);
        break;
      case "MUSIC_PAGE_TYPE_ARTIST":
      case "MUSIC_PAGE_TYPE_USER_CHANNEL":
        this.item_type = "artist";
        __classPrivateFieldGet9(this, _MusicResponsiveListItem_instances, "m", _MusicResponsiveListItem_parseArtist).call(this);
        break;
      case "MUSIC_PAGE_TYPE_LIBRARY_ARTIST":
        this.item_type = "library_artist";
        __classPrivateFieldGet9(this, _MusicResponsiveListItem_instances, "m", _MusicResponsiveListItem_parseLibraryArtist).call(this);
        break;
      default:
        if (__classPrivateFieldGet9(this, _MusicResponsiveListItem_flex_columns, "f")[1]) {
          __classPrivateFieldGet9(this, _MusicResponsiveListItem_instances, "m", _MusicResponsiveListItem_parseVideoOrSong).call(this);
        } else {
          __classPrivateFieldGet9(this, _MusicResponsiveListItem_instances, "m", _MusicResponsiveListItem_parseOther).call(this);
        }
        break;
    }
    if (data.index) {
...
_MusicResponsiveListItem_flex_columns = /* @__PURE__ */ new WeakMap(), _MusicResponsiveListItem_fixed_columns = /* @__PURE__ */ new WeakMap(), _MusicResponsiveListItem_playlist_item_data = /* @__PURE__ */ new WeakMap(), _MusicResponsiveListItem_instances = /* @__PURE__ */ new WeakSet(), _MusicResponsiveListItem_parseOther = /* @__PURE__ */ __name(function _MusicResponsiveListItem_parseOther2() {
  this.title = __classPrivateFieldGet9(this, _MusicResponsiveListItem_flex_columns, "f")[0].key("title").instanceof(Text).toString();
  if (this.endpoint) {
    this.item_type = "endpoint";
  } else {
    this.item_type = "unknown";
  ...
  var _a7;
  const is_video = (_a7 = __classPrivateFieldGet9(this, _MusicResponsiveListItem_flex_columns, "f")[1].key("title").instanceof(Text).runs) === null || _a7 === void 0 ? void 0 : _a7.some((run) => run.text.match(/(.*?) views/));
  if (is_video) {
    this.item_type = "video";
    __classPrivateFieldGet9(this, _MusicResponsiveListItem_instances, "m", _MusicResponsiveListItem_parseVideo).call(this);
  } else {
    this.item_type = "song";
    __classPrivateFieldGet9(this, _MusicResponsiveListItem_instances, "m", _MusicResponsiveListItem_parseSong).call(this);
  }
  ...
  var _a7, _b2, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o;
  this.id = __classPrivateFieldGet9(this, _MusicResponsiveListItem_playlist_item_data, "f").video_id || ((_b2 = (_a7 = this.endpoint) === null || _a7 === void 0 ? void 0 : _a7.payload) === null || _b2 === void 0 ? void 0 : _b2.videoId);
  this.title = __classPrivateFieldGet9(this, _MusicResponsiveListItem_flex_columns, "f")[0].key("title").instanceof(Text).toString();
  const duration_text = ((_d = (_c = __classPrivateFieldGet9(this, _MusicResponsiveListItem_flex_columns, "f")[1].key("title").instanceof(Text).runs) === null || _c === void 0 ? void 0 : _c.find((run) => /^\d+$/.test(run.text.replace(/:/g, "")))) === null || _d === void 0 ? void 0 : _d.text) || ((_g = (_f = (_e = __classPrivateFieldGet9(this, _MusicResponsiveListItem_fixed_columns, "f")) === null || _e === void 0 ? void 0 : _e[0]) === null || _f === void 0 ? void 0 : _f.key("title").instanceof(Text)) === null || _g === void 0 ? void 0 : _g.toString());
  duration_text && (this.duration = {
    text: duration_text,
    seconds: timeToSeconds(duration_text)
  });
  const album = ((_h = __classPrivateFieldGet9(this, _MusicResponsiveListItem_flex_columns, "f")[1].key("title").instanceof(Text).runs) === null || _h === void 0 ? void 0 : _h.find((run) => {
    var _a8, _b3;
    return (_b3 = (_a8 = Reflect.get(run, "endpoint")) === null || _a8 === void 0 ? void 0 : _a8.payload) === null || _b3 === void 0 ? void 0 : _b3.browseId.startsWith("MPR");
  })) || ((_k = (_j = __classPrivateFieldGet9(this, _MusicResponsiveListItem_flex_columns, "f")[2]) === null || _j === void 0 ? void 0 : _j.key("title").instanceof(Text).runs) === null || _k === void 0 ? void 0 : _k.find((run) => {
    var _a8, _b3;
    return (_b3 = (_a8 = Reflect.get(run, "endpoint")) === null || _a8 === void 0 ? void 0 : _a8.payload) === null || _b3 === void 0 ? void 0 : _b3.browseId.startsWith("MPR");
  }));
  if (album) {
  ...
  const artists = (_o = __classPrivateFieldGet9(this, _MusicResponsiveListItem_flex_columns, "f")[1].key("title").instanceof(Text).runs) === null || _o === void 0 ? void 0 : _o.filter((run) => {
    var _a8, _b3;
    return (_b3 = (_a8 = Reflect.get(run, "endpoint")) === null || _a8 === void 0 ? void 0 : _a8.payload) === null || _b3 === void 0 ? void 0 : _b3.browseId.startsWith("UC");
  });
  if (artists) {
    this.artists = artists.map((artist) => {
      var _a8, _b3;
  ...
  var _a7, _b2, _c, _d, _e, _f, _g, _h;
  this.id = __classPrivateFieldGet9(this, _MusicResponsiveListItem_playlist_item_data, "f").video_id;
  this.title = __classPrivateFieldGet9(this, _MusicResponsiveListItem_flex_columns, "f")[0].key("title").instanceof(Text).toString();
  this.views = (_b2 = (_a7 = __classPrivateFieldGet9(this, _MusicResponsiveListItem_flex_columns, "f")[1].key("title").instanceof(Text).runs) === null || _a7 === void 0 ? void 0 : _a7.find((run) => run.text.match(/(.*?) views/))) === null || _b2 === void 0 ? void 0 : _b2.text;
  const authors = (_c = __classPrivateFieldGet9(this, _MusicResponsiveListItem_flex_columns, "f")[1].key("title").instanceof(Text).runs) === null || _c === void 0 ? void 0 : _c.filter((run) => {
    var _a8, _b3;
    return (_b3 = (_a8 = Reflect.get(run, "endpoint")) === null || _a8 === void 0 ? void 0 : _a8.payload) === null || _b3 === void 0 ? void 0 : _b3.browseId.startsWith("UC");
  });
  if (authors) {
    this.authors = authors.map((author) => {
      ...
      return {
        name: author.text,
        channel_id: (_b3 = (_a8 = author.endpoint) === null || _a8 === void 0 ? void 0 : _a8.payload) === null || _b3 === void 0 ? void 0 : _b3.browseId,
        endpoint: author.endpoint
      };
    });
  }
  const duration_text = ((_e = (_d = __classPrivateFieldGet9(this, _MusicResponsiveListItem_flex_columns, "f")[1].key("title").instanceof(Text).runs) === null || _d === void 0 ? void 0 : _d.find((run) => /^\d+$/.test(run.text.replace(/:/g, "")))) === null || _e === void 0 ? void 0 : _e.text) || ((_h = (_g = (_f = __classPrivateFieldGet9(this, _MusicResponsiveListItem_fixed_columns, "f")[0]) === null || _f === void 0 ? void 0 : _f.key("title").instanceof(Text).runs) === null || _g === void 0 ? void 0 : _g.find((run) => /^\d+$/.test(run.text.replace(/:/g, "")))) === null || _h === void 0 ? void 0 : _h.text);
  duration_text && (this.duration = {
    text: duration_text,
    seconds: timeToSeconds(duration_text)
  });
  ...
  this.name = __classPrivateFieldGet9(this, _MusicResponsiveListItem_flex_columns, "f")[0].key("title").instanceof(Text).toString();
  this.subtitle = __classPrivateFieldGet9(this, _MusicResponsiveListItem_flex_columns, "f")[1].key("title").instanceof(Text);
  ...
  this.name = __classPrivateFieldGet9(this, _MusicResponsiveListItem_flex_columns, "f")[0].key("title").instanceof(Text).toString();
  this.subtitle = __classPrivateFieldGet9(this, _MusicResponsiveListItem_flex_columns, "f")[1].key("title").instanceof(Text);
  this.song_count = ((_c = (_b2 = (_a7 = this.subtitle) === null || _a7 === void 0 ? void 0 : _a7.runs) === null || _b2 === void 0 ? void 0 : _b2.find((run) => /^\d+(,\d+)? songs?$/i.test(run.text))) === null || _c === void 0 ? void 0 : _c.text) || "";
  ...
  this.id = (_b2 = (_a7 = this.endpoint) === null || _a7 === void 0 ? void 0 : _a7.payload) === null || _b2 === void 0 ? void 0 : _b2.browseId;
  this.title = __classPrivateFieldGet9(this, _MusicResponsiveListItem_flex_columns, "f")[0].key("title").instanceof(Text).toString();
  const author = (_c = __classPrivateFieldGet9(this, _MusicResponsiveListItem_flex_columns, "f")[1].key("title").instanceof(Text).runs) === null || _c === void 0 ? void 0 : _c.find((run) => {
    var _a8, _b3;
    return (_b3 = (_a8 = Reflect.get(run, "endpoint")) === null || _a8 === void 0 ? void 0 : _a8.payload) === null || _b3 === void 0 ? void 0 : _b3.browseId.startsWith("UC");
  });
  author && (this.author = {
  ...
  this.year = (_g = (_f = __classPrivateFieldGet9(this, _MusicResponsiveListItem_flex_columns, "f")[1].key("title").instanceof(Text).runs) === null || _f === void 0 ? void 0 : _f.find((run) => /^[12][0-9]{3}$/.test(run.text))) === null || _g === void 0 ? void 0 : _g.text;
  ...
  this.id = (_b2 = (_a7 = this.endpoint) === null || _a7 === void 0 ? void 0 : _a7.payload) === null || _b2 === void 0 ? void 0 : _b2.browseId;
  this.title = __classPrivateFieldGet9(this, _MusicResponsiveListItem_flex_columns, "f")[0].key("title").instanceof(Text).toString();
  const item_count_run = (_c = __classPrivateFieldGet9(this, _MusicResponsiveListItem_flex_columns, "f")[1].key("title").instanceof(Text).runs) === null || _c === void 0 ? void 0 : _c.find((run) => run.text.match(/\d+ (song|songs)/));
  this.item_count = item_count_run ? item_count_run.text : void 0;
  const author = (_d = __classPrivateFieldGet9(this, _MusicResponsiveListItem_flex_columns, "f")[1].key("title").instanceof(Text).runs) === null || _d === void 0 ? void 0 : _d.find((run) => {
    var _a8, _b3;
    return (_b3 = (_a8 = Reflect.get(run, "endpoint")) === null || _a8 === void 0 ? void 0 : _a8.payload) === null || _b3 === void 0 ? void 0 : _b3.browseId.startsWith("UC");
  });
  if (author) {
...
var PlaylistPanelVideoWrapper = class extends YTNode {
  constructor(data) {
    ...
    this.counterpart = ((_a7 = data.counterpart) === null || _a7 === void 0 ? void 0 : _a7.map((item) => parser_default.parseItem(item.counterpartRenderer, PlaylistPanelVideo_default))) || [];
  }
};
...
var MusicSortFilterButton = class extends YTNode {
  constructor(data) {
    ...
    super();
    this.title = new Text(data.title).toString();
    this.icon_type = ((_a7 = data.icon) === null || _a7 === void 0 ? void 0 : _a7.icon_type) || null;
...
var MusicVisualHeader = class extends YTNode {
  constructor(data) {
    ...
    super();
    this.title = new Text(data.title);
    this.thumbnails = data.thumbnail ? Thumbnail_default.fromResponse((_a7 = data.thumbnail.musicThumbnailRenderer) === null || _a7 === void 0 ? void 0 : _a7.thumbnail) : [];
    this.menu = parser_default.parseItem(data.menu, Menu_default);
    this.foreground_thumbnails = data.foregroundThumbnail ? Thumbnail_default.fromResponse((_b2 = data.foregroundThumbnail.musicThumbnailRenderer) === null || _b2 === void 0 ? void 0 : _b2.thumbnail) : [];
  }
};
...
var RichListHeader = class extends YTNode {
  constructor(data) {
    ...
    this.title = new Text(data.title);
    this.subtitle = new Text(data.subtitle);
    this.title_style = (_a7 = data === null || data === void 0 ? void 0 : data.titleStyle) === null || _a7 === void 0 ? void 0 : _a7.style;
    this.icon_type = (_b2 = data === null || data === void 0 ? void 0 : data.icon) === null || _b2 === void 0 ? void 0 : _b2.iconType;
  }
};
...
var RichMetadata = class extends YTNode {
  constructor(data) {
    ...
    this.subtitle = new Text(data.subtitle);
    this.call_to_action = new Text(data.callToAction);
    if ((_a7 = data.callToActionIcon) === null || _a7 === void 0 ? void 0 : _a7.iconType) {
      this.icon_type = (_b2 = data.callToActionIcon) === null || _b2 === void 0 ? void 0 : _b2.iconType;
    }
    this.endpoint = new NavigationEndpoint_default(data.endpoint);
  }
};
...
var SearchBox = class extends YTNode {
  constructor(data) {
    super();
    this.endpoint = new NavigationEndpoint_default(data.endpoint);
    this.search_button = parser_default.parseItem(data.searchButton);
    this.clear_button = parser_default.parseItem(data.clearButton);
...
var Shelf = class extends YTNode {
  constructor(data) {
    ...
    if ((_a7 = data.icon) === null || _a7 === void 0 ? void 0 : _a7.iconType) {
      this.icon_type = (_b2 = data.icon) === null || _b2 === void 0 ? void 0 : _b2.iconType;
    }
    if (data.menu) {
      this.menu = parser_default.parseItem(data.menu);
    }
...
var TopicChannelDetails = class extends YTNode {
  constructor(data) {
    ...
    super();
    this.title = new Text(data.title);
    this.avatar = Thumbnail_default.fromResponse((_a7 = data.thumbnail) !== null && _a7 !== void 0 ? _a7 : data.avatar);
    this.subtitle = new Text(data.subtitle);
    this.subscribe_button = parser_default.parseItem(data.subscribeButton, SubscribeButton_default);
    this.endpoint = new NavigationEndpoint_default(data.navigationEndpoint);
  }
...
var TwoColumnWatchNextResults = class extends YTNode {
  constructor(data) {
    ...
    if (autoplayData) {
      this.autoplay = {
        sets: autoplayData.sets.map((set) => __classPrivateFieldGet10(this, _TwoColumnWatchNextResults_instances, "m", _TwoColumnWatchNextResults_parseAutoplaySet).call(this, set))
      };
      if (autoplayData.modifiedSets) {
        this.autoplay.modified_sets = autoplayData.modifiedSets.map((set) => __classPrivateFieldGet10(this, _TwoColumnWatchNextResults_instances, "m", _TwoColumnWatchNextResults_parseAutoplaySet).call(this, set));
      }
...
var VideoSecondaryInfo = class extends YTNode {
  constructor(data) {
    ...
    if (Reflect.has(data, "attributedDescription")) {
      this.description = new Text(__classPrivateFieldGet11(this, _VideoSecondaryInfo_instances, "m", _VideoSecondaryInfo_convertAttributedDescriptionToRuns).call(this, data.attributedDescription));
    }
    this.subscribe_button = parser_default.parseItem(data.subscribeButton, [SubscribeButton_default, Button_default]);
...
var YTNodeGenerator = class {
  static isIgnoredKey(key) {
    return typeof key === "string" && __classPrivateFieldGet12(this, _a2, "f", _YTNodeGenerator_ignored_keys).has(key);
  }
  ...
  static createRuntimeClass(classname, key_info) {
    var _b2, _key_info;
    __classPrivateFieldGet12(this, _a2, "m", _YTNodeGenerator_logNewClass).call(this, classname, key_info);
    const node = (_b2 = /* @__PURE__ */ __name(class extends YTNode {
      static set key_info(key_info2) {
        __classPrivateFieldSet9(this, _b2, new Map(key_info2), "f", _key_info);
      }
      static get key_info() {
        return [...__classPrivateFieldGet12(this, _b2, "f", _key_info).entries()];
      }
      constructor(data) {
        super();
        ...
        if (did_change) {
          ...
          __classPrivateFieldGet12(YTNodeGenerator, _a2, "m", _YTNodeGenerator_logChangedKeys).call(YTNodeGenerator, classname, node.key_info, changed_keys);
        }
        ...
        for (const [key, value] of key_info2) {
          let snake_key = __classPrivateFieldGet12(YTNodeGenerator, _a2, "m", _YTNodeGenerator_camelToSnake).call(YTNodeGenerator, key);
          if (value.type === "misc" && value.misc_type === "NavigationEndpoint")
            snake_key = "endpoint";
          Reflect.set(this, snake_key, YTNodeGenerator.parse(key, value, data));
        }
      }
    }, "_b"), _b2.type = classname, _key_info = { value: /* @__PURE__ */ new Map() }, _b2);
    node.key_info = key_info;
    Object.defineProperty(node, "name", { value: classname, writable: false });
    return node;
  }
  static introspect(classdata) {
    const key_info = __classPrivateFieldGet12(this, _a2, "m", _YTNodeGenerator_introspect).call(this, classdata);
    const dependencies = /* @__PURE__ */ new Map();
    for (const [, value] of key_info) {
      if (value.type === "renderer" || value.type === "renderer_list")
        for (const renderer of value.renderers) {
          const example = __classPrivateFieldGet12(this, _a2, "f", _YTNodeGenerator_renderers_examples)[renderer];
          if (example)
  ...
  static generateTypescriptClass(classname, key_info) {
    ...
    for (const [key, value] of key_info) {
      let snake_key = __classPrivateFieldGet12(this, _a2, "m", _YTNodeGenerator_camelToSnake).call(this, key);
      if (value.type === "misc" && value.misc_type === "NavigationEndpoint")
        snake_key = "endpoint";
...
`;
  ...
  static toTypeDeclaration(inference_type, indentation = 0) {
    switch (inference_type.type) {
      ...
      case "object": {
        return `{
${inference_type.keys.map(([key, value]) => `${" ".repeat((indentation + 2) * 2)}${__classPrivateFieldGet12(this, _a2, "m", _YTNodeGenerator_camelToSnake).call(this, key)}${value.optional ? "?" : ""}: ${this.toTypeDeclaration(value, indentation + 1)}`).join(",\n")}
      ...
      case "object":
        {
          ...
          parser = `{
${inference_type.keys.map(([key2, value]) => `${" ".repeat((indentation + 2) * 2)}${__classPrivateFieldGet12(this, _a2, "m", _YTNodeGenerator_camelToSnake).call(this, key2)}: ${this.toParser(key2, value, new_keypath, indentation + 1)}`).join(",\n")}
${" ".repeat((indentation + 1) * 2)}}`;
        }
        break;
      case "misc":
  ...
  static parse(key, inference_type, data, key_path = ["data"]) {
    const should_optional = !inference_type.optional || __classPrivateFieldGet12(this, _a2, "m", _YTNodeGenerator_hasDataFromKeyPath).call(this, { data }, [...key_path, key]);
    switch (inference_type.type) {
      case "renderer": {
        return should_optional ? Parser.parseItem(__classPrivateFieldGet12(this, _a2, "m", _YTNodeGenerator_accessDataFromKeyPath).call(this, { data }, [...key_path, key]), inference_type.renderers.map((type) => Parser.getParserByName(type))) : void 0;
      }
      case "renderer_list": {
        return should_optional ? Parser.parse(__classPrivateFieldGet12(this, _a2, "m", _YTNodeGenerator_accessDataFromKeyPath).call(this, { data }, [...key_path, key]), true, inference_type.renderers.map((type) => Parser.getParserByName(type))) : void 0;
      }
      case "object": {
        const obj = {};
      ...
      case "misc":
        switch (inference_type.misc_type) {
          case "NavigationEndpoint":
            return should_optional ? new NavigationEndpoint_default(__classPrivateFieldGet12(this, _a2, "m", _YTNodeGenerator_accessDataFromKeyPath).call(this, { data }, [...key_path, key])) : void 0;
          case "Text":
            return should_optional ? new Text(__classPrivateFieldGet12(this, _a2, "m", _YTNodeGenerator_accessDataFromKeyPath).call(this, { data }, [...key_path, key])) : void 0;
          case "Thumbnail":
            return should_optional ? Thumbnail_default.fromResponse(__classPrivateFieldGet12(this, _a2, "m", _YTNodeGenerator_accessDataFromKeyPath).call(this, { data }, [...key_path, key])) : void 0;
          case "Author": {
            const author_should_optional = !inference_type.optional || __classPrivateFieldGet12(this, _a2, "m", _YTNodeGenerator_hasDataFromKeyPath).call(this, { data }, [...key_path, inference_type.params[0]]);
            return author_should_optional ? new Author_default(__classPrivateFieldGet12(this, _a2, "m", _YTNodeGenerator_accessDataFromKeyPath).call(this, { data }, [...key_path, inference_type.params[0]]), inference_type.params[1] ? __classPrivateFieldGet12(this, _a2, "m", _YTNodeGenerator_accessDataFromKeyPath).call(this, { data }, [...key_path, inference_type.params[1]]) : void 0) : void 0;
          }
        }
        throw new Error("Unreachable code reached! Switch missing case!");
      case "primative":
      case "unknown":
        return __classPrivateFieldGet12(this, _a2, "m", _YTNodeGenerator_accessDataFromKeyPath).call(this, { data }, [...key_path, key]);
    }
  }
  static inferType(key, value) {
    let return_value = false;
    if (return_value = this.isRenderer(value)) {
      __classPrivateFieldGet12(this, _a2, "f", _YTNodeGenerator_renderers_examples)[return_value] = value[Reflect.ownKeys(value)[0]];
      return {
        type: "renderer",
    ...
    if (return_value = this.isRendererList(value)) {
      for (const [key2, value2] of Object.entries(return_value)) {
        __classPrivateFieldGet12(this, _a2, "f", _YTNodeGenerator_renderers_examples)[key2] = value2;
      }
      return {
        type: "renderer_list",
...
_a2 = YTNodeGenerator, _YTNodeGenerator_camelToSnake = /* @__PURE__ */ __name(function _YTNodeGenerator_camelToSnake2(str) {
...
The following keys where altered: ${changed_keys.map(([key]) => __classPrivateFieldGet12(this, _a2, "m", _YTNodeGenerator_camelToSnake).call(this, key)).join(", ")}
...
${this.generateTypescriptClass(classname, key_info)}`);
  ...
  const key_info = __classPrivateFieldGet12(this, _a2, "m", _YTNodeGenerator_passOne).call(this, classdata);
  return __classPrivateFieldGet12(this, _a2, "m", _YTNodeGenerator_passTwo).call(this, key_info);
...
var Parser = class {
  static setParserErrorHandler(handler) {
    __classPrivateFieldSet10(this, _a3, handler, "f", _Parser_errorHandler);
  }
  static parseResponse(data) {
    var _b2, _c;
    const parsed_data = {};
    __classPrivateFieldGet13(this, _a3, "m", _Parser_createMemo).call(this);
    const contents = this.parse(data.contents);
    const contents_memo = __classPrivateFieldGet13(this, _a3, "m", _Parser_getMemo).call(this);
    if (contents) {
      parsed_data.contents = contents;
      parsed_data.contents_memo = contents_memo;
    }
    __classPrivateFieldGet13(this, _a3, "m", _Parser_clearMemo).call(this);
    __classPrivateFieldGet13(this, _a3, "m", _Parser_createMemo).call(this);
    const on_response_received_actions = data.onResponseReceivedActions ? this.parseRR(data.onResponseReceivedActions) : null;
    const on_response_received_actions_memo = __classPrivateFieldGet13(this, _a3, "m", _Parser_getMemo).call(this);
    ...
    const on_response_received_endpoints_memo = __classPrivateFieldGet13(this, _a3, "m", _Parser_getMemo).call(this);
    ...
    const on_response_received_commands_memo = __classPrivateFieldGet13(this, _a3, "m", _Parser_getMemo).call(this);
    ...
    const continuation_contents_memo = __classPrivateFieldGet13(this, _a3, "m", _Parser_getMemo).call(this);
    ...
    const actions_memo = __classPrivateFieldGet13(this, _a3, "m", _Parser_getMemo).call(this);
    if (actions) {
    ...
    const live_chat_item_context_menu_supported_renderers_memo = __classPrivateFieldGet13(this, _a3, "m", _Parser_getMemo).call(this);
    ...
    const header_memo = __classPrivateFieldGet13(this, _a3, "m", _Parser_getMemo).call(this);
    if (header) {
    ...
    const sidebar_memo = __classPrivateFieldGet13(this, _a3, "m", _Parser_getMemo).call(this);
    if (sidebar) {
    ...
    if (items) {
      ...
      parsed_data.items_memo = __classPrivateFieldGet13(this, _a3, "m", _Parser_getMemo).call(this);
    }
    __classPrivateFieldGet13(this, _a3, "m", _Parser_clearMemo).call(this);
    return parsed_data;
  }
  static parseItem(data, validTypes) {
    ...
    if (!this.shouldIgnore(classname)) {
      try {
        ...
        __classPrivateFieldGet13(this, _a3, "m", _Parser_addToMemo).call(this, classname, result);
        return result;
      } catch (err) {
        __classPrivateFieldGet13(this, _a3, "f", _Parser_errorHandler).call(this, { classname, classdata: data[keys[0]], err });
        return null;
      }
    }
    return null;
  ...
  extra() {
    Parser.parseItem({}, [MusicMultiSelectMenuItem_default, MusicMultiSelectMenuItem_default]);
  }
...
This is a bug, please report it at ${Platform.shim.info.bugs_url}`));
  ...
  static getParserByName(classname) {
    const ParserConstructor = __classPrivateFieldGet13(this, _a3, "f", _Parser_rt_nodes).get(classname);
  ...
  static hasParser(classname) {
    return __classPrivateFieldGet13(this, _a3, "f", _Parser_rt_nodes).has(classname);
  }
  static addRuntimeParser(classname, ParserConstructor) {
    __classPrivateFieldGet13(this, _a3, "f", _Parser_rt_nodes).set(classname, ParserConstructor);
    __classPrivateFieldGet13(this, _a3, "f", _Parser_dynamic_nodes).set(classname, ParserConstructor);
  }
  static getDynamicParsers() {
    return Object.fromEntries(__classPrivateFieldGet13(this, _a3, "f", _Parser_dynamic_nodes));
  }
};
__name(Parser, "Parser");
_a3 = Parser, _Parser_clearMemo = /* @__PURE__ */ __name(function _Parser_clearMemo2() {
  __classPrivateFieldSet10(Parser, _a3, null, "f", _Parser_memo);
}, "_Parser_clearMemo"), _Parser_createMemo = /* @__PURE__ */ __name(function _Parser_createMemo2() {
  __classPrivateFieldSet10(Parser, _a3, new Memo(), "f", _Parser_memo);
}, "_Parser_createMemo"), _Parser_addToMemo = /* @__PURE__ */ __name(function _Parser_addToMemo2(classname, result) {
  if (!__classPrivateFieldGet13(Parser, _a3, "f", _Parser_memo))
    return;
  const list = __classPrivateFieldGet13(Parser, _a3, "f", _Parser_memo).get(classname);
  if (!list)
    return __classPrivateFieldGet13(Parser, _a3, "f", _Parser_memo).set(classname, [result]);
  list.push(result);
  ...
  return __classPrivateFieldGet13(Parser, _a3, "f", _Parser_memo);
...
_Parser_errorHandler = { value: __classPrivateFieldGet13(Parser, _a3, "m", _Parser_printError) };
...
_Parser_rt_nodes = { value: new Map(Array.from(Object.entries(nodes_exports))) };
...
var AccountInfo = class {
  constructor(response) {
    ...
    __classPrivateFieldSet11(this, _AccountInfo_page, parser_default.parseResponse(response.data), "f");
    if (!__classPrivateFieldGet14(this, _AccountInfo_page, "f").contents)
      throw new InnertubeError("Page contents not found");
    const account_section_list = __classPrivateFieldGet14(this, _AccountInfo_page, "f").contents.array().as(AccountSectionList_default).first();
  ...
  get page() {
    return __classPrivateFieldGet14(this, _AccountInfo_page, "f");
  }
};
...
var Analytics = class {
  constructor(response) {
    ...
    __classPrivateFieldSet12(this, _Analytics_page, parser_default.parseResponse(response.data), "f");
    this.sections = (_a7 = __classPrivateFieldGet15(this, _Analytics_page, "f").contents_memo) === null || _a7 === void 0 ? void 0 : _a7.getType(Element_default).map((el) => el.model).flatMap((el) => !el ? [] : el);
  }
  get page() {
    return __classPrivateFieldGet15(this, _Analytics_page, "f");
  }
};
...
var Feed = class {
  constructor(actions, response, already_parsed = false) {
    ...
    if (__classPrivateFieldGet16(this, _Feed_instances, "m", _Feed_isParsed).call(this, response) || already_parsed) {
      __classPrivateFieldSet13(this, _Feed_page, response, "f");
    } else {
      __classPrivateFieldSet13(this, _Feed_page, parser_default.parseResponse(response.data), "f");
    }
    const memo = concatMemos(...[
      __classPrivateFieldGet16(this, _Feed_page, "f").contents_memo,
      __classPrivateFieldGet16(this, _Feed_page, "f").continuation_contents_memo,
      __classPrivateFieldGet16(this, _Feed_page, "f").on_response_received_commands_memo,
      __classPrivateFieldGet16(this, _Feed_page, "f").on_response_received_endpoints_memo,
      __classPrivateFieldGet16(this, _Feed_page, "f").on_response_received_actions_memo,
      __classPrivateFieldGet16(this, _Feed_page, "f").sidebar_memo,
      __classPrivateFieldGet16(this, _Feed_page, "f").header_memo
    ]);
    if (!memo)
      throw new InnertubeError("No memo found in feed");
    __classPrivateFieldSet13(this, _Feed_memo, memo, "f");
    __classPrivateFieldSet13(this, _Feed_actions, actions, "f");
  }
  ...
  get videos() {
    return Feed.getVideosFromMemo(__classPrivateFieldGet16(this, _Feed_memo, "f"));
  }
  get posts() {
    return __classPrivateFieldGet16(this, _Feed_memo, "f").getType(BackstagePost_default, Post_default, SharedPost_default);
  }
  get channels() {
    return __classPrivateFieldGet16(this, _Feed_memo, "f").getType(Channel_default, GridChannel_default);
  }
  get playlists() {
    return Feed.getPlaylistsFromMemo(__classPrivateFieldGet16(this, _Feed_memo, "f"));
  }
  get memo() {
    return __classPrivateFieldGet16(this, _Feed_memo, "f");
  }
  get page_contents() {
    var _a7;
    const tab_content = (_a7 = __classPrivateFieldGet16(this, _Feed_memo, "f").getType(Tab_default)) === null || _a7 === void 0 ? void 0 : _a7.first().content;
    const reload_continuation_items = __classPrivateFieldGet16(this, _Feed_memo, "f").getType(ReloadContinuationItemsCommand).first();
    const append_continuation_items = __classPrivateFieldGet16(this, _Feed_memo, "f").getType(AppendContinuationItemsAction_default).first();
    return tab_content || reload_continuation_items || append_continuation_items;
  }
  get shelves() {
    return __classPrivateFieldGet16(this, _Feed_memo, "f").getType(Shelf_default, RichShelf_default, ReelShelf_default);
  }
  getShelf(title) {
  ...
  get secondary_contents() {
    var _a7, _b2;
    if (!((_a7 = __classPrivateFieldGet16(this, _Feed_page, "f").contents) === null || _a7 === void 0 ? void 0 : _a7.is_node))
      return void 0;
    const node = (_b2 = __classPrivateFieldGet16(this, _Feed_page, "f").contents) === null || _b2 === void 0 ? void 0 : _b2.item();
    if (!node.is(TwoColumnBrowseResults_default, TwoColumnSearchResults_default))
      return void 0;
    return node.secondary_contents;
  }
  get actions() {
    return __classPrivateFieldGet16(this, _Feed_actions, "f");
  }
  get page() {
    return __classPrivateFieldGet16(this, _Feed_page, "f");
  }
  get has_continuation() {
    return (__classPrivateFieldGet16(this, _Feed_memo, "f").get("ContinuationItem") || []).length > 0;
  }
  getContinuationData() {
    return __awaiter4(this, void 0, void 0, function* () {
      if (__classPrivateFieldGet16(this, _Feed_continuation, "f")) {
        if (__classPrivateFieldGet16(this, _Feed_continuation, "f").length > 1)
          throw new InnertubeError("There are too many continuations, you'll need to find the correct one yourself in this.page");
        if (__classPrivateFieldGet16(this, _Feed_continuation, "f").length === 0)
          throw new InnertubeError("There are no continuations");
        const response = yield __classPrivateFieldGet16(this, _Feed_continuation, "f")[0].endpoint.call(__classPrivateFieldGet16(this, _Feed_actions, "f"), { parse: true });
        return response;
      }
      __classPrivateFieldSet13(this, _Feed_continuation, __classPrivateFieldGet16(this, _Feed_memo, "f").getType(ContinuationItem_default), "f");
      if (__classPrivateFieldGet16(this, _Feed_continuation, "f"))
...
var TabbedFeed = class extends Feed_default {
  constructor(actions, data, already_parsed = false) {
    ...
    __classPrivateFieldSet14(this, _TabbedFeed_actions, actions, "f");
    __classPrivateFieldSet14(this, _TabbedFeed_tabs, (_a7 = this.page.contents_memo) === null || _a7 === void 0 ? void 0 : _a7.getType(Tab_default), "f");
  }
  get tabs() {
    var _a7, _b2;
    return (_b2 = (_a7 = __classPrivateFieldGet17(this, _TabbedFeed_tabs, "f")) === null || _a7 === void 0 ? void 0 : _a7.map((tab) => tab.title.toString())) !== null && _b2 !== void 0 ? _b2 : [];
  }
  getTabByName(title) {
    var _a7;
    return __awaiter5(this, void 0, void 0, function* () {
      const tab = (_a7 = __classPrivateFieldGet17(this, _TabbedFeed_tabs, "f")) === null || _a7 === void 0 ? void 0 : _a7.find((tab2) => tab2.title.toLowerCase() === title.toLowerCase());
      if (!tab)
        throw new InnertubeError(`Tab "${title}" not found`);
      if (tab.selected)
        return this;
      const response = yield tab.endpoint.call(__classPrivateFieldGet17(this, _TabbedFeed_actions, "f"));
      return new TabbedFeed(__classPrivateFieldGet17(this, _TabbedFeed_actions, "f"), response, false);
    });
  }
  getTabByURL(url) {
    var _a7;
    return __awaiter5(this, void 0, void 0, function* () {
      const tab = (_a7 = __classPrivateFieldGet17(this, _TabbedFeed_tabs, "f")) === null || _a7 === void 0 ? void 0 : _a7.find((tab2) => {
        var _a8;
  ...
  hasTabWithURL(url) {
    var _a7, _b2;
    return (_b2 = (_a7 = __classPrivateFieldGet17(this, _TabbedFeed_tabs, "f")) === null || _a7 === void 0 ? void 0 : _a7.some((tab) => {
      var _a8;
...
var FilterableFeed = class extends Feed_default {
  ...
  get filter_chips() {
    var _a7, _b2;
    if (__classPrivateFieldGet18(this, _FilterableFeed_chips, "f"))
      return __classPrivateFieldGet18(this, _FilterableFeed_chips, "f") || [];
    ...
    __classPrivateFieldSet15(this, _FilterableFeed_chips, this.memo.getType(ChipCloudChip_default), "f");
    return __classPrivateFieldGet18(this, _FilterableFeed_chips, "f") || [];
  }
  get filters() {
...
var Comments = class {
  constructor(actions, data, already_parsed = false) {
    ...
    __classPrivateFieldSet16(this, _Comments_page, already_parsed ? data : parser_default.parseResponse(data), "f");
    __classPrivateFieldSet16(this, _Comments_actions, actions, "f");
    const contents = __classPrivateFieldGet19(this, _Comments_page, "f").on_response_received_endpoints;
    if (!contents)
    ...
    this.contents = observe(threads.map((thread) => {
      var _a8;
      (_a8 = thread.comment) === null || _a8 === void 0 ? void 0 : _a8.setActions(__classPrivateFieldGet19(this, _Comments_actions, "f"));
      thread.setActions(__classPrivateFieldGet19(this, _Comments_actions, "f"));
      return thread;
    }));
    __classPrivateFieldSet16(this, _Comments_continuation, (_c = body_node === null || body_node === void 0 ? void 0 : body_node.contents) === null || _c === void 0 ? void 0 : _c.firstOfType(ContinuationItem_default), "f");
  }
  applySort(sort) {
    var _a7, _b2, _c, _d;
    return __awaiter8(this, void 0, void 0, function* () {
      ...
      if (button.selected)
        return this;
      const response = yield button.endpoint.call(__classPrivateFieldGet19(this, _Comments_actions, "f"), { parse: true });
      return new Comments(__classPrivateFieldGet19(this, _Comments_actions, "f"), response, true);
    });
  }
  createComment(text) {
    var _a7;
    return __awaiter8(this, void 0, void 0, function* () {
      ...
      const response = yield button.endpoint.call(__classPrivateFieldGet19(this, _Comments_actions, "f"), { commentText: text });
      return response;
    });
  }
  getContinuation() {
    return __awaiter8(this, void 0, void 0, function* () {
      if (!__classPrivateFieldGet19(this, _Comments_continuation, "f"))
        throw new InnertubeError("Continuation not found");
      const data = yield __classPrivateFieldGet19(this, _Comments_continuation, "f").endpoint.call(__classPrivateFieldGet19(this, _Comments_actions, "f"), { parse: true });
      const page = Object.assign({}, __classPrivateFieldGet19(this, _Comments_page, "f"));
      ...
      return new Comments(__classPrivateFieldGet19(this, _Comments_actions, "f"), page, true);
    });
  }
  get has_continuation() {
    return !!__classPrivateFieldGet19(this, _Comments_continuation, "f");
  }
  get page() {
...
var ItemMenu = class {
  constructor(data, actions) {
    ...
    __classPrivateFieldSet17(this, _ItemMenu_page, data, "f");
    __classPrivateFieldSet17(this, _ItemMenu_actions, actions, "f");
    ...
    __classPrivateFieldSet17(this, _ItemMenu_items, menu.as(Menu_default).items, "f");
  }
  selectItem(item) {
    return __awaiter11(this, void 0, void 0, function* () {
      ...
      if (item instanceof Button_default) {
        ...
        const button = __classPrivateFieldGet20(this, _ItemMenu_items, "f").find((button2) => {
      ...
      const response = yield endpoint.call(__classPrivateFieldGet20(this, _ItemMenu_actions, "f"), { parse: true });
      return response;
    });
  }
  items() {
    return __classPrivateFieldGet20(this, _ItemMenu_items, "f");
  }
  page() {
    return __classPrivateFieldGet20(this, _ItemMenu_page, "f");
  }
};
...
var Playlist2 = class extends Feed_default {
  constructor(actions, data, already_parsed = false) {
    ...
    this.info = Object.assign(Object.assign({}, (_a7 = this.page.metadata) === null || _a7 === void 0 ? void 0 : _a7.item().as(PlaylistMetadata_default)), {
      ...
      total_items: __classPrivateFieldGet21(this, _Playlist_instances, "m", _Playlist_getStat).call(this, 0, primary_info),
      views: __classPrivateFieldGet21(this, _Playlist_instances, "m", _Playlist_getStat).call(this, 1, primary_info),
      last_updated: __classPrivateFieldGet21(this, _Playlist_instances, "m", _Playlist_getStat).call(this, 2, primary_info),
...
var Library = class extends Feed_default {
  constructor(actions, data) {
    ...
    if (!this.page.contents_memo)
      throw new InnertubeError("Page contents not found");
    const stats = (_a7 = this.page.contents_memo.getType(ProfileColumnStats_default)) === null || _a7 === void 0 ? void 0 : _a7[0];
    const user_info = (_b2 = this.page.contents_memo.getType(ProfileColumnUserInfo_default)) === null || _b2 === void 0 ? void 0 : _b2[0];
    ...
    this.sections = shelves.map((shelf) => {
      ...
      return {
        ...
        getAll: () => __classPrivateFieldGet22(this, _Library_instances, "m", _Library_getAll).call(this, shelf)
      };
    });
  }
  get history() {
...
var SmoothedQueue = class {
  constructor() {
    ...
    __classPrivateFieldSet18(this, _SmoothedQueue_last_update_time, null, "f");
    __classPrivateFieldSet18(this, _SmoothedQueue_estimated_update_interval, null, "f");
    __classPrivateFieldSet18(this, _SmoothedQueue_callback, null, "f");
    __classPrivateFieldSet18(this, _SmoothedQueue_action_queue, [], "f");
    __classPrivateFieldSet18(this, _SmoothedQueue_next_update_id, null, "f");
    __classPrivateFieldSet18(this, _SmoothedQueue_poll_response_delay_queue, new DelayQueue(), "f");
  }
  enqueueActionGroup(group) {
    if (__classPrivateFieldGet23(this, _SmoothedQueue_last_update_time, "f") !== null) {
      const delay = Date.now() - __classPrivateFieldGet23(this, _SmoothedQueue_last_update_time, "f");
      __classPrivateFieldGet23(this, _SmoothedQueue_poll_response_delay_queue, "f").back.push(delay);
      if (5 < __classPrivateFieldGet23(this, _SmoothedQueue_poll_response_delay_queue, "f").front.length + __classPrivateFieldGet23(this, _SmoothedQueue_poll_response_delay_queue, "f").back.length) {
        if (!__classPrivateFieldGet23(this, _SmoothedQueue_poll_response_delay_queue, "f").front.length) {
          __classPrivateFieldGet23(this, _SmoothedQueue_poll_response_delay_queue, "f").front = __classPrivateFieldGet23(this, _SmoothedQueue_poll_response_delay_queue, "f").back;
          __classPrivateFieldGet23(this, _SmoothedQueue_poll_response_delay_queue, "f").front.reverse();
          __classPrivateFieldGet23(this, _SmoothedQueue_poll_response_delay_queue, "f").back = [];
        }
        __classPrivateFieldGet23(this, _SmoothedQueue_poll_response_delay_queue, "f").front.pop();
      }
      __classPrivateFieldSet18(this, _SmoothedQueue_estimated_update_interval, Math.max(...__classPrivateFieldGet23(this, _SmoothedQueue_poll_response_delay_queue, "f").getValues()), "f");
    }
    __classPrivateFieldSet18(this, _SmoothedQueue_last_update_time, Date.now(), "f");
    __classPrivateFieldGet23(this, _SmoothedQueue_action_queue, "f").push(group);
    if (__classPrivateFieldGet23(this, _SmoothedQueue_next_update_id, "f") === null) {
      __classPrivateFieldSet18(this, _SmoothedQueue_next_update_id, setTimeout(this.emitSmoothedActions.bind(this)), "f");
    }
  }
  emitSmoothedActions() {
    __classPrivateFieldSet18(this, _SmoothedQueue_next_update_id, null, "f");
    if (__classPrivateFieldGet23(this, _SmoothedQueue_action_queue, "f").length) {
      let delay = 1e4;
      if (__classPrivateFieldGet23(this, _SmoothedQueue_estimated_update_interval, "f") !== null && __classPrivateFieldGet23(this, _SmoothedQueue_last_update_time, "f") !== null) {
        delay = __classPrivateFieldGet23(this, _SmoothedQueue_estimated_update_interval, "f") - Date.now() + __classPrivateFieldGet23(this, _SmoothedQueue_last_update_time, "f");
      }
      delay = __classPrivateFieldGet23(this, _SmoothedQueue_action_queue, "f").length < delay / 80 ? 1 : Math.ceil(__classPrivateFieldGet23(this, _SmoothedQueue_action_queue, "f").length / (delay / 80));
      const actions = flattenQueue(__classPrivateFieldGet23(this, _SmoothedQueue_action_queue, "f").splice(0, delay));
      if (__classPrivateFieldGet23(this, _SmoothedQueue_callback, "f")) {
        __classPrivateFieldGet23(this, _SmoothedQueue_callback, "f").call(this, actions);
      }
      if (__classPrivateFieldGet23(this, _SmoothedQueue_action_queue, "f") !== null) {
        delay == 1 ? (delay = __classPrivateFieldGet23(this, _SmoothedQueue_estimated_update_interval, "f") / __classPrivateFieldGet23(this, _SmoothedQueue_action_queue, "f").length, delay *= Math.random() + 0.5, delay = Math.min(1e3, delay), delay = Math.max(80, delay)) : delay = 80;
        __classPrivateFieldSet18(this, _SmoothedQueue_next_update_id, setTimeout(this.emitSmoothedActions.bind(this), delay), "f");
      }
    }
  }
  clear() {
    if (__classPrivateFieldGet23(this, _SmoothedQueue_next_update_id, "f") !== null) {
      clearTimeout(__classPrivateFieldGet23(this, _SmoothedQueue_next_update_id, "f"));
      __classPrivateFieldSet18(this, _SmoothedQueue_next_update_id, null, "f");
    }
    __classPrivateFieldSet18(this, _SmoothedQueue_action_queue, [], "f");
  }
  set callback(cb) {
    __classPrivateFieldSet18(this, _SmoothedQueue_callback, cb, "f");
  }
  get callback() {
    return __classPrivateFieldGet23(this, _SmoothedQueue_callback, "f");
  }
  get action_queue() {
    return __classPrivateFieldGet23(this, _SmoothedQueue_action_queue, "f");
  }
  get estimated_update_interval() {
    return __classPrivateFieldGet23(this, _SmoothedQueue_estimated_update_interval, "f");
  }
  get last_update_time() {
    return __classPrivateFieldGet23(this, _SmoothedQueue_last_update_time, "f");
  }
  get next_update_id() {
    return __classPrivateFieldGet23(this, _SmoothedQueue_next_update_id, "f");
  }
  get poll_response_delay_queue() {
    return __classPrivateFieldGet23(this, _SmoothedQueue_poll_response_delay_queue, "f");
  }
};
...
var LiveChat2 = class extends EventEmitterLike {
  constructor(video_info) {
    ...
    __classPrivateFieldSet19(this, _LiveChat_video_id, video_info.basic_info.id, "f");
    __classPrivateFieldSet19(this, _LiveChat_channel_id, video_info.basic_info.channel_id, "f");
    __classPrivateFieldSet19(this, _LiveChat_actions, video_info.actions, "f");
    __classPrivateFieldSet19(this, _LiveChat_continuation, (_a7 = video_info.livechat) === null || _a7 === void 0 ? void 0 : _a7.continuation, "f");
    ...
    this.smoothed_queue.callback = (actions) => __awaiter14(this, void 0, void 0, function* () {
      if (!actions.length) {
        yield __classPrivateFieldGet24(this, _LiveChat_instances, "m", _LiveChat_wait).call(this, 2e3);
      } else if (actions.length < 10) {
        yield __classPrivateFieldGet24(this, _LiveChat_instances, "m", _LiveChat_emitSmoothedActions).call(this, actions);
      } else if (this.is_replay) {
        __classPrivateFieldGet24(this, _LiveChat_instances, "m", _LiveChat_emitSmoothedActions).call(this, actions);
        yield __classPrivateFieldGet24(this, _LiveChat_instances, "m", _LiveChat_wait).call(this, 2e3);
      } else {
        __classPrivateFieldGet24(this, _LiveChat_instances, "m", _LiveChat_emitSmoothedActions).call(this, actions);
      }
      if (this.running) {
        __classPrivateFieldGet24(this, _LiveChat_instances, "m", _LiveChat_pollLivechat).call(this);
      }
    });
  }
  on(type, listener) {
  ...
  start() {
    if (!this.running) {
      this.running = true;
      __classPrivateFieldGet24(this, _LiveChat_instances, "m", _LiveChat_pollLivechat).call(this);
      __classPrivateFieldGet24(this, _LiveChat_instances, "m", _LiveChat_pollMetadata).call(this);
    }
  }
  stop() {
  ...
  sendMessage(text) {
    return __awaiter14(this, void 0, void 0, function* () {
      const response = yield __classPrivateFieldGet24(this, _LiveChat_actions, "f").execute("/live_chat/send_message", {
        params: proto_default.encodeMessageParams(__classPrivateFieldGet24(this, _LiveChat_channel_id, "f"), __classPrivateFieldGet24(this, _LiveChat_video_id, "f")),
  ...
  applyFilter(filter) {
    ...
    if (filter === "TOP_CHAT") {
      if ((_d = menu_items === null || menu_items === void 0 ? void 0 : menu_items.at(0)) === null || _d === void 0 ? void 0 : _d.selected)
        return;
      __classPrivateFieldSet19(this, _LiveChat_continuation, (_e = menu_items === null || menu_items === void 0 ? void 0 : menu_items.at(0)) === null || _e === void 0 ? void 0 : _e.continuation, "f");
    } else {
      if ((_f = menu_items === null || menu_items === void 0 ? void 0 : menu_items.at(1)) === null || _f === void 0 ? void 0 : _f.selected)
        return;
      __classPrivateFieldSet19(this, _LiveChat_continuation, (_g = menu_items === null || menu_items === void 0 ? void 0 : menu_items.at(1)) === null || _g === void 0 ? void 0 : _g.continuation, "f");
    }
  }
  getItemMenu(item) {
    return __awaiter14(this, void 0, void 0, function* () {
      ...
      const response = yield item.key("menu_endpoint").instanceof(NavigationEndpoint_default).call(__classPrivateFieldGet24(this, _LiveChat_actions, "f"), { parse: true });
      if (!response)
        throw new InnertubeError("Could not retrieve item menu.", item);
      return new ItemMenu_default(response, __classPrivateFieldGet24(this, _LiveChat_actions, "f"));
    });
  }
  selectButton(button) {
    return __awaiter14(this, void 0, void 0, function* () {
      const response = yield button.endpoint.call(__classPrivateFieldGet24(this, _LiveChat_actions, "f"), { parse: true });
      return response;
    });
  }
};
...
_LiveChat_actions = /* @__PURE__ */ new WeakMap(), _LiveChat_video_id = /* @__PURE__ */ new WeakMap(), _LiveChat_channel_id = /* @__PURE__ */ new WeakMap(), _LiveChat_continuation = /* @__PURE__ */ new WeakMap(), _LiveChat_mcontinuation = /* @__PURE__ */ new WeakMap(), _LiveChat_retry_count = /* @__PURE__ */ new WeakMap(), _LiveChat_instances = /* @__PURE__ */ new WeakSet(), _LiveChat_pollLivechat = /* @__PURE__ */ __name(function _LiveChat_pollLivechat2() {
  (() => __awaiter14(this, void 0, void 0, function* () {
    var _a7, _b2;
    try {
      const response = yield __classPrivateFieldGet24(this, _LiveChat_actions, "f").execute(this.is_replay ? "live_chat/get_live_chat_replay" : "live_chat/get_live_chat", { continuation: __classPrivateFieldGet24(this, _LiveChat_continuation, "f"), parse: true });
      ...
      __classPrivateFieldSet19(this, _LiveChat_continuation, contents.continuation.token, "f");
      if (contents.header) {
        this.initial_info = contents;
        this.emit("start", contents);
        if (this.running)
          __classPrivateFieldGet24(this, _LiveChat_instances, "m", _LiveChat_pollLivechat2).call(this);
      } else {
        this.smoothed_queue.enqueueActionGroup(contents.actions);
      }
      __classPrivateFieldSet19(this, _LiveChat_retry_count, 0, "f");
    } catch (err) {
      this.emit("error", err);
      if ((__classPrivateFieldSet19(this, _LiveChat_retry_count, (_b2 = __classPrivateFieldGet24(this, _LiveChat_retry_count, "f"), _a7 = _b2++, _b2), "f"), _a7) < 10) {
        yield __classPrivateFieldGet24(this, _LiveChat_instances, "m", _LiveChat_wait).call(this, 2e3);
        __classPrivateFieldGet24(this, _LiveChat_instances, "m", _LiveChat_pollLivechat2).call(this);
      } else {
  ...
  return __awaiter14(this, void 0, void 0, function* () {
    ...
    for (const action of action_queue) {
      yield __classPrivateFieldGet24(this, _LiveChat_instances, "m", _LiveChat_wait).call(this, emit_delay_ms);
  ...
  (() => __awaiter14(this, void 0, void 0, function* () {
    ...
    try {
      const payload = { videoId: __classPrivateFieldGet24(this, _LiveChat_video_id, "f") };
      if (__classPrivateFieldGet24(this, _LiveChat_mcontinuation, "f")) {
        payload.continuation = __classPrivateFieldGet24(this, _LiveChat_mcontinuation, "f");
      }
      const response = yield __classPrivateFieldGet24(this, _LiveChat_actions, "f").execute("/updated_metadata", payload);
      const data = parser_default.parseResponse(response.data);
      __classPrivateFieldSet19(this, _LiveChat_mcontinuation, (_a7 = data.continuation) === null || _a7 === void 0 ? void 0 : _a7.token, "f");
      this.metadata = {
      ...
      yield __classPrivateFieldGet24(this, _LiveChat_instances, "m", _LiveChat_wait).call(this, 5e3);
      if (this.running)
        __classPrivateFieldGet24(this, _LiveChat_instances, "m", _LiveChat_pollMetadata2).call(this);
    } catch (err) {
      yield __classPrivateFieldGet24(this, _LiveChat_instances, "m", _LiveChat_wait).call(this, 2e3);
      if (this.running)
        __classPrivateFieldGet24(this, _LiveChat_instances, "m", _LiveChat_pollMetadata2).call(this);
...
var NotificationsMenu = class {
  constructor(actions, response) {
    ...
    __classPrivateFieldSet20(this, _NotificationsMenu_actions, actions, "f");
    __classPrivateFieldSet20(this, _NotificationsMenu_page, parser_default.parseResponse(response.data), "f");
    this.header = __classPrivateFieldGet25(this, _NotificationsMenu_page, "f").actions_memo.getType(SimpleMenuHeader_default).first();
    this.contents = __classPrivateFieldGet25(this, _NotificationsMenu_page, "f").actions_memo.getType(Notification_default);
  }
  getContinuation() {
    return __awaiter15(this, void 0, void 0, function* () {
      const continuation = __classPrivateFieldGet25(this, _NotificationsMenu_page, "f").actions_memo.getType(ContinuationItem_default).first();
      if (!continuation)
        throw new InnertubeError("Continuation not found");
      const response = yield continuation.endpoint.call(__classPrivateFieldGet25(this, _NotificationsMenu_actions, "f"), { parse: false });
      return new NotificationsMenu(__classPrivateFieldGet25(this, _NotificationsMenu_actions, "f"), response);
    });
  }
  get page() {
    return __classPrivateFieldGet25(this, _NotificationsMenu_page, "f");
  }
};
...
var Settings = class {
  constructor(actions, response) {
    ...
    __classPrivateFieldSet21(this, _Settings_actions, actions, "f");
    __classPrivateFieldSet21(this, _Settings_page, parser_default.parseResponse(response.data), "f");
    this.sidebar = (_a7 = __classPrivateFieldGet26(this, _Settings_page, "f").sidebar) === null || _a7 === void 0 ? void 0 : _a7.as(SettingsSidebar_default);
    if (!__classPrivateFieldGet26(this, _Settings_page, "f").contents)
      throw new InnertubeError("Page contents not found");
    const tab = __classPrivateFieldGet26(this, _Settings_page, "f").contents.item().as(TwoColumnBrowseResults_default).tabs.array().as(Tab_default).get({ selected: true });
    if (!tab)
  ...
  selectSidebarItem(target_item) {
    return __awaiter17(this, void 0, void 0, function* () {
      ...
      const response = yield item.endpoint.call(__classPrivateFieldGet26(this, _Settings_actions, "f"), { parse: false });
      return new Settings(__classPrivateFieldGet26(this, _Settings_actions, "f"), response);
    });
  }
  ...
  get page() {
    return __classPrivateFieldGet26(this, _Settings_page, "f");
  }
};
...
var TimeWatched = class {
  constructor(response) {
    ...
    __classPrivateFieldSet22(this, _TimeWatched_page, parser_default.parseResponse(response.data), "f");
    if (!__classPrivateFieldGet27(this, _TimeWatched_page, "f").contents)
      throw new InnertubeError("Page contents not found");
    const tab = __classPrivateFieldGet27(this, _TimeWatched_page, "f").contents.item().as(SingleColumnBrowseResults_default).tabs.get({ selected: true });
    if (!tab)
  ...
  get page() {
    return __classPrivateFieldGet27(this, _TimeWatched_page, "f");
  }
};
...
var UniversalCache = class {
  constructor(persistent, persistent_directory) {
    ...
    __classPrivateFieldSet23(this, _UniversalCache_cache, new Platform.shim.Cache(persistent, persistent_directory), "f");
  }
  get cache_dir() {
    return __classPrivateFieldGet28(this, _UniversalCache_cache, "f").cache_dir;
  }
  get(key) {
    return __classPrivateFieldGet28(this, _UniversalCache_cache, "f").get(key);
  }
  set(key, value) {
    return __classPrivateFieldGet28(this, _UniversalCache_cache, "f").set(key, value);
  }
  remove(key) {
    return __classPrivateFieldGet28(this, _UniversalCache_cache, "f").remove(key);
  }
};
...
var HTTPClient = class {
  constructor(session, cookie, fetch) {
    ...
    __classPrivateFieldSet24(this, _HTTPClient_session, session, "f");
    __classPrivateFieldSet24(this, _HTTPClient_cookie, cookie, "f");
    __classPrivateFieldSet24(this, _HTTPClient_fetch, fetch || Platform.shim.fetch, "f");
  }
  get fetch_function() {
    return __classPrivateFieldGet29(this, _HTTPClient_fetch, "f");
  }
  fetch(input, init) {
    return __awaiter18(this, void 0, void 0, function* () {
      const innertube_url = Constants_default.URLS.API.PRODUCTION_1 + __classPrivateFieldGet29(this, _HTTPClient_session, "f").api_version;
      ...
      request_headers.set("x-goog-visitor-id", __classPrivateFieldGet29(this, _HTTPClient_session, "f").context.client.visitorData || "");
      request_headers.set("x-origin", request_url.origin);
      request_headers.set("x-youtube-client-version", __classPrivateFieldGet29(this, _HTTPClient_session, "f").context.client.clientVersion || "");
      if (Platform.shim.server) {
        request_headers.set("User-Agent", getRandomUserAgent("desktop"));
        request_headers.set("origin", request_url.origin);
      }
      request_url.searchParams.set("key", __classPrivateFieldGet29(this, _HTTPClient_session, "f").key);
      ...
      if (content_type === "application/json" && is_innertube_req && typeof body === "string") {
        ...
        const n_body = Object.assign(Object.assign({}, json), {
          context: JSON.parse(JSON.stringify(__classPrivateFieldGet29(this, _HTTPClient_session, "f").context))
        });
        __classPrivateFieldGet29(this, _HTTPClient_instances, "m", _HTTPClient_adjustContext).call(this, n_body.context, n_body.client);
      ...
      if (__classPrivateFieldGet29(this, _HTTPClient_session, "f").logged_in && is_innertube_req && !is_web_kids) {
        const oauth = __classPrivateFieldGet29(this, _HTTPClient_session, "f").oauth;
        ...
        if (__classPrivateFieldGet29(this, _HTTPClient_cookie, "f")) {
          const papisid = getStringBetweenStrings(__classPrivateFieldGet29(this, _HTTPClient_cookie, "f"), "PAPISID=", ";");
          if (papisid) {
            request_headers.set("authorization", yield generateSidAuth(papisid));
            request_headers.set("x-goog-authuser", __classPrivateFieldGet29(this, _HTTPClient_session, "f").account_index.toString());
          }
          request_headers.set("cookie", __classPrivateFieldGet29(this, _HTTPClient_cookie, "f"));
        }
      }
      const request = new Platform.shim.Request(request_url, input instanceof Platform.shim.Request ? input : init);
      const response = yield __classPrivateFieldGet29(this, _HTTPClient_fetch, "f").call(this, request, {
        body: request_body,
...
_HTTPClient_session = /* @__PURE__ */ new WeakMap(), _HTTPClient_cookie = /* @__PURE__ */ new WeakMap(), _HTTPClient_fetch = /* @__PURE__ */ new WeakMap(), _HTTPClient_instances = /* @__PURE__ */ new WeakSet(), _HTTPClient_adjustContext = /* @__PURE__ */ __name(function _HTTPClient_adjustContext2(ctx, client) {
  switch (client) {
    ...
    case "YTSTUDIO_ANDROID":
      ...
      break;
    case "TV_EMBEDDED":
      ctx.client.clientName = Constants_default.CLIENTS.TV_EMBEDDED.NAME;
...
var FormatUtils = class {
        ...
        pull: (controller) => __awaiter19(this, void 0, void 0, function* () {
          ...
          return new Promise((resolve, reject) => __awaiter19(this, void 0, void 0, function* () {
            ...
            try {
              ...
              try {
                for (var _e = true, _f = __asyncValues(streamToIterable(body)), _g; _g = yield _f.next(), _b2 = _g.done, !_b2; ) {
                  _d = _g.value;
                  _e = false;
                  try {
                    const chunk = _d;
  ...
  static toDash(streaming_data, url_transformer = (url) => url, format_filter, cpn, player, actions) {
    return __awaiter19(this, void 0, void 0, function* () {
      ...
      mpd.replaceWith(__classPrivateFieldGet30(this, _a4, "m", _FormatUtils_el).call(this, document, "MPD", {
      ...
      yield __classPrivateFieldGet30(this, _a4, "m", _FormatUtils_generateAdaptationSet).call(this, document, period, adaptive_formats, url_transformer, cpn, player, actions);
...
_a4 = FormatUtils, _FormatUtils_el = /* @__PURE__ */ __name(function _FormatUtils_el2(document, tag, attrs, children = []) {
    ...
    for (let i = 0; i < mime_types.length; i++) {
      if (mime_objects[i][0].has_audio && mime_objects[i][0].audio_track) {
        ...
        for (let j = 0; j < track_ids.length; j++) {
          ...
          children.push(__classPrivateFieldGet30(this, _a4, "m", _FormatUtils_el).call(this, document, "Role", {
            schemeIdUri: "urn:mpeg:dash:role:2011",
            value: role
          }));
          const set = __classPrivateFieldGet30(this, _a4, "m", _FormatUtils_el).call(this, document, "AdaptationSet", {
            id: `${set_id++}`,
          ...
          for (const format of track_objects[j]) {
            yield __classPrivateFieldGet30(this, _a4, "m", _FormatUtils_generateRepresentationAudio).call(this, document, set, format, url_transformer, cpn, player, actions);
          }
        }
      } else {
        const set = __classPrivateFieldGet30(this, _a4, "m", _FormatUtils_el).call(this, document, "AdaptationSet", {
        ...
        for (const format of mime_objects[i]) {
          if (format.has_video) {
            yield __classPrivateFieldGet30(this, _a4, "m", _FormatUtils_generateRepresentationVideo).call(this, document, set, format, url_transformer, cpn, player, actions);
          } else {
            yield __classPrivateFieldGet30(this, _a4, "m", _FormatUtils_generateRepresentationAudio).call(this, document, set, format, url_transformer, cpn, player, actions);
          }
        }
  ...
  return __awaiter19(this, void 0, void 0, function* () {
    ...
    const representation = __classPrivateFieldGet30(this, _a4, "m", _FormatUtils_el).call(this, document, "Representation", {
    ...
    yield __classPrivateFieldGet30(this, _a4, "m", _FormatUtils_generateSegmentInformation).call(this, document, representation, format, (_g = url_transformer(url)) === null || _g === void 0 ? void 0 : _g.toString(), actions);
  });
  ...
  return __awaiter19(this, void 0, void 0, function* () {
    ...
    const representation = __classPrivateFieldGet30(this, _a4, "m", _FormatUtils_el).call(this, document, "Representation", {
      ...
      __classPrivateFieldGet30(this, _a4, "m", _FormatUtils_el).call(this, document, "AudioChannelConfiguration", {
  ...
  return __awaiter19(this, void 0, void 0, function* () {
    if (format.is_type_otf) {
      ...
      const { resolved_url, segment_durations } = yield __classPrivateFieldGet30(this, _a4, "m", _FormatUtils_getOTFSegmentInformation).call(this, url, actions);
      ...
      for (const segment_duration of segment_durations) {
        ...
        segment_elements.push(__classPrivateFieldGet30(this, _a4, "m", _FormatUtils_el).call(this, document, "S", attributes));
      }
      representation.appendChild(__classPrivateFieldGet30(this, _a4, "m", _FormatUtils_el).call(this, document, "SegmentTemplate", {
        startNumber: "1",
        timescale: "1000",
        initialization: `${resolved_url}&sq=0`,
        media: `${resolved_url}&sq=$Number$`
      }, [
        __classPrivateFieldGet30(this, _a4, "m", _FormatUtils_el).call(this, document, "SegmentTimeline", {}, segment_elements)
      ]));
    } else {
      if (!format.index_range || !format.init_range)
        throw new InnertubeError("Index and init ranges not available", { format });
      representation.appendChild(__classPrivateFieldGet30(this, _a4, "m", _FormatUtils_el).call(this, document, "BaseURL", {}, [
        document.createTextNode(url)
      ]));
      representation.appendChild(__classPrivateFieldGet30(this, _a4, "m", _FormatUtils_el).call(this, document, "SegmentBase", {
        indexRange: `${format.index_range.start}-${format.index_range.end}`
      }, [
        __classPrivateFieldGet30(this, _a4, "m", _FormatUtils_el).call(this, document, "Initialization", {
...
var MediaInfo = class {
  constructor(data, actions, cpn) {
    ...
    __classPrivateFieldSet25(this, _MediaInfo_actions, actions, "f");
    ...
    __classPrivateFieldSet25(this, _MediaInfo_page, [info, next], "f");
    __classPrivateFieldSet25(this, _MediaInfo_cpn, cpn, "f");
    if (((_b2 = info.playability_status) === null || _b2 === void 0 ? void 0 : _b2.status) === "ERROR")
      throw new InnertubeError("This video is unavailable", info.playability_status);
    this.streaming_data = info.streaming_data;
    this.playability_status = info.playability_status;
    __classPrivateFieldSet25(this, _MediaInfo_playback_tracking, info.playback_tracking, "f");
  }
  toDash(url_transformer, format_filter) {
    return __awaiter20(this, void 0, void 0, function* () {
      return FormatUtils_default.toDash(this.streaming_data, url_transformer, format_filter, __classPrivateFieldGet31(this, _MediaInfo_cpn, "f"), __classPrivateFieldGet31(this, _MediaInfo_actions, "f").session.player, __classPrivateFieldGet31(this, _MediaInfo_actions, "f"));
    });
  }
  ...
  download(options = {}) {
    return __awaiter20(this, void 0, void 0, function* () {
      return FormatUtils_default.download(options, __classPrivateFieldGet31(this, _MediaInfo_actions, "f"), this.playability_status, this.streaming_data, __classPrivateFieldGet31(this, _MediaInfo_actions, "f").session.player, this.cpn);
    });
  }
  addToWatchHistory(client_name = Constants_default.CLIENTS.WEB.NAME, client_version = Constants_default.CLIENTS.WEB.VERSION, replacement = "https://www.") {
    return __awaiter20(this, void 0, void 0, function* () {
      if (!__classPrivateFieldGet31(this, _MediaInfo_playback_tracking, "f"))
        throw new InnertubeError("Playback tracking not available");
      const url_params = {
        cpn: __classPrivateFieldGet31(this, _MediaInfo_cpn, "f"),
        fmt: 251,
        rtn: 0,
        rt: 0
      };
      const url = __classPrivateFieldGet31(this, _MediaInfo_playback_tracking, "f").videostats_playback_url.replace("https://s.", replacement);
      const response = yield __classPrivateFieldGet31(this, _MediaInfo_actions, "f").stats(url, {
        client_name,
        client_version
      }, url_params);
      return response;
  ...
  get actions() {
    return __classPrivateFieldGet31(this, _MediaInfo_actions, "f");
  }
  get cpn() {
    return __classPrivateFieldGet31(this, _MediaInfo_cpn, "f");
  }
  get page() {
    return __classPrivateFieldGet31(this, _MediaInfo_page, "f");
  }
};
...
var VideoInfo = class extends MediaInfo {
  constructor(data, actions, cpn) {
    ...
    if (results && secondary_results) {
      if (((_p = info.microformat) === null || _p === void 0 ? void 0 : _p.is(PlayerMicroformat_default)) && ((_q = info.microformat) === null || _q === void 0 ? void 0 : _q.category) === "Gaming") {
        const row = (_t = (_s = (_r = results.firstOfType(VideoSecondaryInfo_default)) === null || _r === void 0 ? void 0 : _r.metadata) === null || _s === void 0 ? void 0 : _s.rows) === null || _t === void 0 ? void 0 : _t.firstOfType(RichMetadataRow_default);
        if (row === null || row === void 0 ? void 0 : row.is(RichMetadataRow_default)) {
          this.game_info = {
            title: (_v = (_u = row === null || row === void 0 ? void 0 : row.contents) === null || _u === void 0 ? void 0 : _u.firstOfType(RichMetadata_default)) === null || _v === void 0 ? void 0 : _v.title,
            release_year: (_x = (_w = row === null || row === void 0 ? void 0 : row.contents) === null || _w === void 0 ? void 0 : _w.firstOfType(RichMetadata_default)) === null || _x === void 0 ? void 0 : _x.subtitle
          };
        }
      }
      ...
      this.related_chip_cloud = (_y = secondary_results.firstOfType(RelatedChipCloud_default)) === null || _y === void 0 ? void 0 : _y.content.item().as(ChipCloud_default);
      if (two_col === null || two_col === void 0 ? void 0 : two_col.playlist) {
        this.playlist = two_col.playlist;
      }
      this.watch_next_feed = ((_z = secondary_results.firstOfType(ItemSection_default)) === null || _z === void 0 ? void 0 : _z.contents) || secondary_results;
      if (this.watch_next_feed && Array.isArray(this.watch_next_feed) && ((_0 = this.watch_next_feed.at(-1)) === null || _0 === void 0 ? void 0 : _0.is(ContinuationItem_default)))
        __classPrivateFieldSet26(this, _VideoInfo_watch_next_continuation, (_1 = this.watch_next_feed.pop()) === null || _1 === void 0 ? void 0 : _1.as(ContinuationItem_default), "f");
      this.player_overlays = (_2 = next === null || next === void 0 ? void 0 : next.player_overlays) === null || _2 === void 0 ? void 0 : _2.item().as(PlayerOverlay_default);
      if (two_col === null || two_col === void 0 ? void 0 : two_col.autoplay) {
        this.autoplay = two_col.autoplay;
      }
      const segmented_like_dislike_button = (_4 = (_3 = this.primary_info) === null || _3 === void 0 ? void 0 : _3.menu) === null || _4 === void 0 ? void 0 : _4.top_level_buttons.firstOfType(SegmentedLikeDislikeButton_default);
      if (((_5 = segmented_like_dislike_button === null || segmented_like_dislike_button === void 0 ? void 0 : segmented_like_dislike_button.like_button) === null || _5 === void 0 ? void 0 : _5.is(ToggleButton_default)) && ((_6 = segmented_like_dislike_button === null || segmented_like_dislike_button === void 0 ? void 0 : segmented_like_dislike_button.dislike_button) === null || _6 === void 0 ? void 0 : _6.is(ToggleButton_default))) {
        this.basic_info.like_count = (_7 = segmented_like_dislike_button === null || segmented_like_dislike_button === void 0 ? void 0 : segmented_like_dislike_button.like_button) === null || _7 === void 0 ? void 0 : _7.like_count;
        this.basic_info.is_liked = (_8 = segmented_like_dislike_button === null || segmented_like_dislike_button === void 0 ? void 0 : segmented_like_dislike_button.like_button) === null || _8 === void 0 ? void 0 : _8.is_toggled;
        this.basic_info.is_disliked = (_9 = segmented_like_dislike_button === null || segmented_like_dislike_button === void 0 ? void 0 : segmented_like_dislike_button.dislike_button) === null || _9 === void 0 ? void 0 : _9.is_toggled;
      }
      const comments_entry_point = (_10 = results.get({ target_id: "comments-entry-point" })) === null || _10 === void 0 ? void 0 : _10.as(ItemSection_default);
      this.comments_entry_point_header = (_11 = comments_entry_point === null || comments_entry_point === void 0 ? void 0 : comments_entry_point.contents) === null || _11 === void 0 ? void 0 : _11.firstOfType(CommentsEntryPointHeader_default);
      this.livechat = (_12 = next === null || next === void 0 ? void 0 : next.contents_memo) === null || _12 === void 0 ? void 0 : _12.getType(LiveChat_default).first();
    }
  }
  ...
  getWatchNextContinuation() {
    var _a7, _b2, _c, _d, _e;
    return __awaiter21(this, void 0, void 0, function* () {
      if (!__classPrivateFieldGet32(this, _VideoInfo_watch_next_continuation, "f"))
        throw new InnertubeError("Watch next feed continuation not found");
      const response = yield (_a7 = __classPrivateFieldGet32(this, _VideoInfo_watch_next_continuation, "f")) === null || _a7 === void 0 ? void 0 : _a7.endpoint.call(this.actions, { parse: true });
      ...
      if ((_d = (_c = this.watch_next_feed) === null || _c === void 0 ? void 0 : _c.at(-1)) === null || _d === void 0 ? void 0 : _d.is(ContinuationItem_default)) {
        __classPrivateFieldSet26(this, _VideoInfo_watch_next_continuation, (_e = this.watch_next_feed.pop()) === null || _e === void 0 ? void 0 : _e.as(ContinuationItem_default), "f");
      } else {
        __classPrivateFieldSet26(this, _VideoInfo_watch_next_continuation, void 0, "f");
      }
      return this;
    });
  }
  ...
  get wn_has_continuation() {
    return !!__classPrivateFieldGet32(this, _VideoInfo_watch_next_continuation, "f");
  }
...
var Album = class {
  constructor(response) {
    ...
    __classPrivateFieldSet27(this, _Album_page, parser_default.parseResponse(response.data), "f");
    this.header = (_a7 = __classPrivateFieldGet33(this, _Album_page, "f").header) === null || _a7 === void 0 ? void 0 : _a7.item().as(MusicDetailHeader_default);
    this.url = ((_b2 = __classPrivateFieldGet33(this, _Album_page, "f").microformat) === null || _b2 === void 0 ? void 0 : _b2.as(MicroformatData_default).url_canonical) || null;
    if (!__classPrivateFieldGet33(this, _Album_page, "f").contents_memo)
      throw new Error("No contents found in the response");
    this.contents = (_c = __classPrivateFieldGet33(this, _Album_page, "f").contents_memo.getType(MusicShelf_default)) === null || _c === void 0 ? void 0 : _c.first().contents;
...
var Artist = class {
  constructor(response, actions) {
    ...
    __classPrivateFieldSet28(this, _Artist_page, parser_default.parseResponse(response.data), "f");
    __classPrivateFieldSet28(this, _Artist_actions, actions, "f");
    ...
    const music_shelf = ((_b2 = __classPrivateFieldGet34(this, _Artist_page, "f").contents_memo) === null || _b2 === void 0 ? void 0 : _b2.getType(MusicShelf_default)) || [];
    const music_carousel_shelf = ((_c = __classPrivateFieldGet34(this, _Artist_page, "f").contents_memo) === null || _c === void 0 ? void 0 : _c.getType(MusicCarouselShelf_default)) || [];
...
var Explore = class {
  constructor(response) {
    ...
    __classPrivateFieldSet29(this, _Explore_page, parser_default.parseResponse(response.data), "f");
    const tab = (_a7 = __classPrivateFieldGet35(this, _Explore_page, "f").contents) === null || _a7 === void 0 ? void 0 : _a7.item().as(SingleColumnBrowseResults_default).tabs.get({ selected: true });
    if (!tab)
      throw new InnertubeError("Could not find target tab.");
...
var HomeFeed2 = class {
  constructor(response, actions) {
    ...
    __classPrivateFieldSet30(this, _HomeFeed_actions, actions, "f");
    __classPrivateFieldSet30(this, _HomeFeed_page, parser_default.parseResponse(response.data), "f");
    const tab = (_a7 = __classPrivateFieldGet36(this, _HomeFeed_page, "f").contents) === null || _a7 === void 0 ? void 0 : _a7.item().as(SingleColumnBrowseResults_default).tabs.get({ selected: true });
    if (!tab)
    ...
    if (tab.key("content").isNull()) {
      ...
      __classPrivateFieldSet30(this, _HomeFeed_continuation, __classPrivateFieldGet36(this, _HomeFeed_page, "f").continuation_contents.as(SectionListContinuation).continuation, "f");
      this.sections = (_b2 = __classPrivateFieldGet36(this, _HomeFeed_page, "f").continuation_contents.as(SectionListContinuation).contents) === null || _b2 === void 0 ? void 0 : _b2.as(MusicCarouselShelf_default);
      return;
    }
    __classPrivateFieldSet30(this, _HomeFeed_continuation, (_c = tab.content) === null || _c === void 0 ? void 0 : _c.as(SectionList_default).continuation, "f");
  ...
  getContinuation() {
    return __awaiter23(this, void 0, void 0, function* () {
      ...
      return new HomeFeed2(response, __classPrivateFieldGet36(this, _HomeFeed_actions, "f"));
    });
  }
  get has_continuation() {
...
var Library2 = class {
  constructor(response, actions) {
    ...
    __classPrivateFieldSet31(this, _Library_page, parser_default.parseResponse(response.data), "f");
    __classPrivateFieldSet31(this, _Library_actions, actions, "f");
    const section_list = (_a7 = __classPrivateFieldGet37(this, _Library_page, "f").contents_memo) === null || _a7 === void 0 ? void 0 : _a7.getType(SectionList_default).first();
    ...
    __classPrivateFieldSet31(this, _Library_continuation, (_e = (_d = this.contents) === null || _d === void 0 ? void 0 : _d.find((list) => list.continuation)) === null || _e === void 0 ? void 0 : _e.continuation, "f");
  }
  applySort(sort_by) {
    var _a7, _b2, _c, _d, _e, _f, _g, _h, _j, _k;
    return __awaiter24(this, void 0, void 0, function* () {
      ...
      if (typeof sort_by === "string") {
        const button = (_a7 = __classPrivateFieldGet37(this, _Library_page, "f").contents_memo) === null || _a7 === void 0 ? void 0 : _a7.getType(MusicSortFilterButton_default).first();
      ...
      const response = yield __classPrivateFieldGet37(this, _Library_actions, "f").execute("/browse", {
        client: "YTMUSIC",
        continuation: cmd.continuation.reloadContinuationData.continuation,
        parse: true
      });
      const previously_selected_item = (_h = (_g = __classPrivateFieldGet37(this, _Library_page, "f").contents_memo) === null || _g === void 0 ? void 0 : _g.getType(MusicMultiSelectMenuItem_default)) === null || _h === void 0 ? void 0 : _h.find((item) => item.selected);
  ...
  applyFilter(filter) {
    ...
    return __awaiter24(this, void 0, void 0, function* () {
      let target_chip;
      const chip_cloud = (_a7 = __classPrivateFieldGet37(this, _Library_page, "f").contents_memo) === null || _a7 === void 0 ? void 0 : _a7.getType(ChipCloud_default).first();
      if (typeof filter === "string") {
      ...
      const response = yield target_cmd.call(__classPrivateFieldGet37(this, _Library_actions, "f"), { client: "YTMUSIC" });
      return new Library2(response, __classPrivateFieldGet37(this, _Library_actions, "f"));
    });
  }
  getContinuation() {
    return __awaiter24(this, void 0, void 0, function* () {
      ...
      const page = yield __classPrivateFieldGet37(this, _Library_actions, "f").execute("/browse", {
        client: "YTMUSIC",
        continuation: __classPrivateFieldGet37(this, _Library_continuation, "f")
      });
      return new LibraryContinuation(page, __classPrivateFieldGet37(this, _Library_actions, "f"));
    });
  }
  get has_continuation() {
  ...
  get filters() {
    var _a7, _b2;
    return ((_b2 = (_a7 = __classPrivateFieldGet37(this, _Library_page, "f").contents_memo) === null || _a7 === void 0 ? void 0 : _a7.getType(ChipCloud_default)) === null || _b2 === void 0 ? void 0 : _b2.first().chips.map((chip) => chip.text)) || [];
  }
  get page() {
    return __classPrivateFieldGet37(this, _Library_page, "f");
  }
};
...
var LibraryContinuation = class {
  constructor(response, actions) {
    ...
    __classPrivateFieldSet31(this, _LibraryContinuation_page, parser_default.parseResponse(response.data), "f");
    __classPrivateFieldSet31(this, _LibraryContinuation_actions, actions, "f");
    if (!__classPrivateFieldGet37(this, _LibraryContinuation_page, "f").continuation_contents)
      throw new InnertubeError("No continuation contents found");
    this.contents = __classPrivateFieldGet37(this, _LibraryContinuation_page, "f").continuation_contents.as(MusicShelfContinuation, GridContinuation);
    __classPrivateFieldSet31(this, _LibraryContinuation_continuation, ((_a7 = __classPrivateFieldGet37(this, _LibraryContinuation_page, "f").continuation_contents) === null || _a7 === void 0 ? void 0 : _a7.key("continuation").isNull()) ? null : (_b2 = __classPrivateFieldGet37(this, _LibraryContinuation_page, "f").continuation_contents) === null || _b2 === void 0 ? void 0 : _b2.key("continuation").string(), "f");
  }
  getContinuation() {
    return __awaiter24(this, void 0, void 0, function* () {
      if (!__classPrivateFieldGet37(this, _LibraryContinuation_continuation, "f"))
        throw new InnertubeError("No continuation available");
      const response = yield __classPrivateFieldGet37(this, _LibraryContinuation_actions, "f").execute("/browse", {
        client: "YTMUSIC",
        continuation: __classPrivateFieldGet37(this, _LibraryContinuation_continuation, "f")
      });
      return new LibraryContinuation(response, __classPrivateFieldGet37(this, _LibraryContinuation_actions, "f"));
    });
  }
  get has_continuation() {
...
var Playlist3 = class {
  constructor(response, actions) {
    ...
    __classPrivateFieldSet32(this, _Playlist_actions, actions, "f");
    __classPrivateFieldSet32(this, _Playlist_page, parser_default.parseResponse(response.data), "f");
    __classPrivateFieldSet32(this, _Playlist_last_fetched_suggestions, null, "f");
    __classPrivateFieldSet32(this, _Playlist_suggestions_continuation, null, "f");
    if (__classPrivateFieldGet38(this, _Playlist_page, "f").continuation_contents) {
      const data = (_a7 = __classPrivateFieldGet38(this, _Playlist_page, "f").continuation_contents) === null || _a7 === void 0 ? void 0 : _a7.as(MusicPlaylistShelfContinuation);
      this.items = data.contents;
      __classPrivateFieldSet32(this, _Playlist_continuation, data.continuation, "f");
    } else {
      if (((_b2 = __classPrivateFieldGet38(this, _Playlist_page, "f").header) === null || _b2 === void 0 ? void 0 : _b2.item().type) === "MusicEditablePlaylistDetailHeader") {
        this.header = (_d = (_c = __classPrivateFieldGet38(this, _Playlist_page, "f").header) === null || _c === void 0 ? void 0 : _c.item().as(MusicEditablePlaylistDetailHeader_default).header) === null || _d === void 0 ? void 0 : _d.as(MusicDetailHeader_default);
      } else {
        this.header = (_e = __classPrivateFieldGet38(this, _Playlist_page, "f").header) === null || _e === void 0 ? void 0 : _e.item().as(MusicDetailHeader_default);
      }
      this.items = ((_f = __classPrivateFieldGet38(this, _Playlist_page, "f").contents_memo) === null || _f === void 0 ? void 0 : _f.getType(MusicPlaylistShelf_default).first().contents) || null;
      __classPrivateFieldSet32(this, _Playlist_continuation, ((_g = __classPrivateFieldGet38(this, _Playlist_page, "f").contents_memo) === null || _g === void 0 ? void 0 : _g.getType(MusicPlaylistShelf_default).first().continuation) || null, "f");
    }
  }
  getContinuation() {
  ...
  getRelated() {
    var _a7, _b2, _c, _d, _e;
    return __awaiter25(this, void 0, void 0, function* () {
      let section_continuation = (_b2 = (_a7 = __classPrivateFieldGet38(this, _Playlist_page, "f").contents_memo) === null || _a7 === void 0 ? void 0 : _a7.getType(SectionList_default)) === null || _b2 === void 0 ? void 0 : _b2[0].continuation;
  ...
  getSuggestions(refresh = true) {
    return __awaiter25(this, void 0, void 0, function* () {
      ...
      if (fetch_result) {
        __classPrivateFieldSet32(this, _Playlist_last_fetched_suggestions, fetch_result.items, "f");
        __classPrivateFieldSet32(this, _Playlist_suggestions_continuation, fetch_result.continuation, "f");
      }
...
_Playlist_page = /* @__PURE__ */ new WeakMap(), _Playlist_actions = /* @__PURE__ */ new WeakMap(), _Playlist_continuation = /* @__PURE__ */ new WeakMap(), _Playlist_last_fetched_suggestions = /* @__PURE__ */ new WeakMap(), _Playlist_suggestions_continuation = /* @__PURE__ */ new WeakMap(), _Playlist_instances2 = /* @__PURE__ */ new WeakSet(), _Playlist_fetchSuggestions = /* @__PURE__ */ __name(function _Playlist_fetchSuggestions2() {
  var _a7, _b2, _c, _d, _e;
  return __awaiter25(this, void 0, void 0, function* () {
    const continuation = __classPrivateFieldGet38(this, _Playlist_suggestions_continuation, "f") || ((_b2 = (_a7 = __classPrivateFieldGet38(this, _Playlist_page, "f").contents_memo) === null || _a7 === void 0 ? void 0 : _a7.get("SectionList")) === null || _b2 === void 0 ? void 0 : _b2[0].as(SectionList_default).continuation);
    if (continuation) {
...
var Recap = class {
  constructor(response, actions) {
    ...
    __classPrivateFieldSet33(this, _Recap_page, parser_default.parseResponse(response.data), "f");
    __classPrivateFieldSet33(this, _Recap_actions, actions, "f");
    const header = (_a7 = __classPrivateFieldGet39(this, _Recap_page, "f").header) === null || _a7 === void 0 ? void 0 : _a7.item();
    this.header = (header === null || header === void 0 ? void 0 : header.is(MusicElementHeader_default)) ? (_d = (_c = (_b2 = __classPrivateFieldGet39(this, _Recap_page, "f").header) === null || _b2 === void 0 ? void 0 : _b2.item().as(MusicElementHeader_default).element) === null || _c === void 0 ? void 0 : _c.model) === null || _d === void 0 ? void 0 : _d.as(HighlightsCarousel_default) : (_e = __classPrivateFieldGet39(this, _Recap_page, "f").header) === null || _e === void 0 ? void 0 : _e.item().as(MusicHeader_default);
    const tab = (_f = __classPrivateFieldGet39(this, _Recap_page, "f").contents) === null || _f === void 0 ? void 0 : _f.item().as(SingleColumnBrowseResults_default).tabs.firstOfType(Tab_default);
    if (!tab)
      throw new InnertubeError("Target tab not found");
...
var Search2 = class {
  constructor(response, actions, is_filtered) {
    ...
    __classPrivateFieldSet34(this, _Search_actions, actions, "f");
    __classPrivateFieldSet34(this, _Search_page, parser_default.parseResponse(response.data), "f");
    if (!__classPrivateFieldGet40(this, _Search_page, "f").contents || !__classPrivateFieldGet40(this, _Search_page, "f").contents_memo)
    ...
    this.contents = tab_content.contents.as(MusicShelf_default, MusicCardShelf, ItemSection_default);
    if (is_filtered) {
      __classPrivateFieldSet34(this, _Search_continuation, (_c = this.contents.firstOfType(MusicShelf_default)) === null || _c === void 0 ? void 0 : _c.continuation, "f");
    }
  }
  getMore(shelf) {
    return __awaiter27(this, void 0, void 0, function* () {
      ...
      const response = yield shelf.endpoint.call(__classPrivateFieldGet40(this, _Search_actions, "f"), { client: "YTMUSIC" });
      if (!response)
        throw new InnertubeError("Endpoint did not return any data");
      return new Search2(response, __classPrivateFieldGet40(this, _Search_actions, "f"), true);
    });
  }
  getContinuation() {
    return __awaiter27(this, void 0, void 0, function* () {
      ...
      return new SearchContinuation(__classPrivateFieldGet40(this, _Search_actions, "f"), response);
    });
  }
  applyFilter(target_filter) {
    ...
    return __awaiter27(this, void 0, void 0, function* () {
      ...
      const response = yield cloud_chip.endpoint.call(__classPrivateFieldGet40(this, _Search_actions, "f"), { client: "YTMUSIC" });
      return new Search2(response, __classPrivateFieldGet40(this, _Search_actions, "f"), true);
    });
  }
  get filters() {
  ...
  get did_you_mean() {
    var _a7;
    return (_a7 = __classPrivateFieldGet40(this, _Search_page, "f").contents_memo) === null || _a7 === void 0 ? void 0 : _a7.getType(DidYouMean_default).first();
  }
  get showing_results_for() {
    var _a7;
    return (_a7 = __classPrivateFieldGet40(this, _Search_page, "f").contents_memo) === null || _a7 === void 0 ? void 0 : _a7.getType(ShowingResultsFor).first();
  }
  get message() {
    var _a7;
    return (_a7 = __classPrivateFieldGet40(this, _Search_page, "f").contents_memo) === null || _a7 === void 0 ? void 0 : _a7.getType(Message_default).first();
  }
  get songs() {
    var _a7;
...
var SearchContinuation = class {
  constructor(actions, response) {
    ...
    __classPrivateFieldSet34(this, _SearchContinuation_actions, actions, "f");
    __classPrivateFieldSet34(this, _SearchContinuation_page, parser_default.parseResponse(response.data), "f");
    this.header = (_a7 = __classPrivateFieldGet40(this, _SearchContinuation_page, "f").header) === null || _a7 === void 0 ? void 0 : _a7.item().as(MusicHeader_default);
    this.contents = (_b2 = __classPrivateFieldGet40(this, _SearchContinuation_page, "f").continuation_contents) === null || _b2 === void 0 ? void 0 : _b2.as(MusicShelfContinuation);
  }
  getContinuation() {
    var _a7;
    return __awaiter27(this, void 0, void 0, function* () {
      if (!((_a7 = this.contents) === null || _a7 === void 0 ? void 0 : _a7.continuation))
        throw new InnertubeError("Continuation not found.");
      const response = yield __classPrivateFieldGet40(this, _SearchContinuation_actions, "f").execute("/search", {
        continuation: this.contents.continuation,
        client: "YTMUSIC"
      });
      return new SearchContinuation(__classPrivateFieldGet40(this, _SearchContinuation_actions, "f"), response);
    });
  }
  get has_continuation() {
    var _a7;
  ...
  get page() {
    return __classPrivateFieldGet40(this, _SearchContinuation_page, "f");
  }
};
...
var TrackInfo = class extends MediaInfo {
  ...
  addToWatchHistory() {
    ...
    return __awaiter28(this, void 0, void 0, function* () {
      return _super.addToWatchHistory.call(this, Constants_default.CLIENTS.YTMUSIC.NAME, Constants_default.CLIENTS.YTMUSIC.VERSION, "https://music.");
    });
  }
  get available_tabs() {
...
var Actions = class {
  ...
  get session() {
    return __classPrivateFieldGet41(this, _Actions_session, "f");
  }
  getVideoInfo(id, cpn, client, playlist_id) {
    ...
    return __awaiter32(this, void 0, void 0, function* () {
      const data = {
        playbackContext: {
          contentPlaybackContext: {
            ...
            signatureTimestamp: ((_a7 = __classPrivateFieldGet41(this, _Actions_session, "f").player) === null || _a7 === void 0 ? void 0 : _a7.sts) || 0,
      ...
      const response = yield __classPrivateFieldGet41(this, _Actions_session, "f").http.fetch("/player", {
        method: "POST",
      ...
      return __classPrivateFieldGet41(this, _Actions_instances, "m", _Actions_wrap).call(this, response);
    });
  }
  stats(url, client, params) {
    return __awaiter32(this, void 0, void 0, function* () {
      ...
      const response = yield __classPrivateFieldGet41(this, _Actions_session, "f").http.fetch(s_url);
      return response;
    });
  }
    ...
    return __awaiter32(this, void 0, void 0, function* () {
      ...
      if (args && !args.protobuf) {
        ...
        if (Reflect.has(data, "browseId")) {
          if (__classPrivateFieldGet41(this, _Actions_instances, "m", _Actions_needsLogin).call(this, data.browseId) && !__classPrivateFieldGet41(this, _Actions_session, "f").logged_in)
      ...
      const response = yield __classPrivateFieldGet41(this, _Actions_session, "f").http.fetch(target_endpoint, {
        method: "POST",
      ...
      if (args === null || args === void 0 ? void 0 : args.parse) {
        ...
        if (__classPrivateFieldGet41(this, _Actions_instances, "m", _Actions_isBrowse).call(this, parsed_response) && ((_b2 = (_a7 = parsed_response.on_response_received_actions) === null || _a7 === void 0 ? void 0 : _a7.first()) === null || _b2 === void 0 ? void 0 : _b2.type) === "navigateAction") {
...
var Player = class {
  ...
  decipher(url, signature_cipher, cipher) {
    ...
    if (signature_cipher || cipher) {
      const signature = Platform.shim.eval(__classPrivateFieldGet42(this, _Player_sig_sc, "f"), {
        sig: args.get("s")
      });
    ...
    if (n) {
      const nsig = Platform.shim.eval(__classPrivateFieldGet42(this, _Player_nsig_sc, "f"), {
        nsig: n
      });
  ...
  cache(cache) {
    return __awaiter33(this, void 0, void 0, function* () {
      ...
      const sig_buf = encoder.encode(__classPrivateFieldGet42(this, _Player_sig_sc, "f"));
      const nsig_buf = encoder.encode(__classPrivateFieldGet42(this, _Player_nsig_sc, "f"));
      const buffer = new ArrayBuffer(12 + sig_buf.byteLength + nsig_buf.byteLength);
      const view = new DataView(buffer);
      view.setUint32(0, Player.LIBRARY_VERSION, true);
      view.setUint32(4, __classPrivateFieldGet42(this, _Player_sig_sc_timestamp, "f"), true);
      ...
      yield cache.set(__classPrivateFieldGet42(this, _Player_player_id, "f"), new Uint8Array(buffer));
    });
  }
  ...
  get url() {
    return new URL(`/s/player/${__classPrivateFieldGet42(this, _Player_player_id, "f")}/player_ias.vflset/en_US/base.js`, Constants_default.URLS.YT_BASE).toString();
  }
  get sts() {
    return __classPrivateFieldGet42(this, _Player_sig_sc_timestamp, "f");
  }
  get nsig_sc() {
    return __classPrivateFieldGet42(this, _Player_nsig_sc, "f");
  }
  get sig_sc() {
    return __classPrivateFieldGet42(this, _Player_sig_sc, "f");
  }
    ...
    return __awaiter34(this, void 0, void 0, function* () {
      ...
      if (this.validateCredentials()) {
        if (!this.has_access_token_expired)
          __classPrivateFieldGet43(this, _OAuth_session, "f").emit("auth", {
            credentials: __classPrivateFieldGet43(this, _OAuth_credentials, "f"),
            status: "SUCCESS"
          });
      } else if (!(yield __classPrivateFieldGet43(this, _OAuth_instances, "m", _OAuth_loadCachedCredentials).call(this))) {
        yield __classPrivateFieldGet43(this, _OAuth_instances, "m", _OAuth_getUserCode).call(this);
      }
    });
  }
  cacheCredentials() {
    ...
    return __awaiter34(this, void 0, void 0, function* () {
      const encoder = new TextEncoder();
      const data = encoder.encode(JSON.stringify(__classPrivateFieldGet43(this, _OAuth_credentials, "f")));
      yield (_a7 = __classPrivateFieldGet43(this, _OAuth_session, "f").cache) === null || _a7 === void 0 ? void 0 : _a7.set("youtubei_oauth_credentials", data.buffer);
    });
  }
  removeCache() {
    var _a7;
    return __awaiter34(this, void 0, void 0, function* () {
      yield (_a7 = __classPrivateFieldGet43(this, _OAuth_session, "f").cache) === null || _a7 === void 0 ? void 0 : _a7.remove("youtubei_oauth_credentials");
    });
  }
  refreshIfRequired() {
    return __awaiter34(this, void 0, void 0, function* () {
      if (this.has_access_token_expired) {
        yield __classPrivateFieldGet43(this, _OAuth_instances, "m", _OAuth_refreshAccessToken).call(this);
      }
    });
  }
  revokeCredentials() {
    return __awaiter34(this, void 0, void 0, function* () {
      if (!__classPrivateFieldGet43(this, _OAuth_credentials, "f"))
        return;
      yield this.removeCache();
      return __classPrivateFieldGet43(this, _OAuth_session, "f").http.fetch_function(new URL(`/o/oauth2/revoke?token=${encodeURIComponent(__classPrivateFieldGet43(this, _OAuth_credentials, "f").access_token)}`, Constants_default.URLS.YT_BASE), {
        method: "post"
      });
    });
  }
  get credentials() {
    return __classPrivateFieldGet43(this, _OAuth_credentials, "f");
  }
  get has_access_token_expired() {
    const timestamp = __classPrivateFieldGet43(this, _OAuth_credentials, "f") ? new Date(__classPrivateFieldGet43(this, _OAuth_credentials, "f").expires).getTime() : -Infinity;
    return new Date().getTime() > timestamp;
  }
  validateCredentials() {
    return __classPrivateFieldGet43(this, _OAuth_credentials, "f") && Reflect.has(__classPrivateFieldGet43(this, _OAuth_credentials, "f"), "access_token") && Reflect.has(__classPrivateFieldGet43(this, _OAuth_credentials, "f"), "refresh_token") && Reflect.has(__classPrivateFieldGet43(this, _OAuth_credentials, "f"), "expires") || false;
  }
};
__name(OAuth, "OAuth");
_OAuth_identity = /* @__PURE__ */ new WeakMap(), _OAuth_session = /* @__PURE__ */ new WeakMap(), _OAuth_credentials = /* @__PURE__ */ new WeakMap(), _OAuth_polling_interval = /* @__PURE__ */ new WeakMap(), _OAuth_instances = /* @__PURE__ */ new WeakSet(), _OAuth_loadCachedCredentials = /* @__PURE__ */ __name(function _OAuth_loadCachedCredentials2() {
  var _a7;
  return __awaiter34(this, void 0, void 0, function* () {
    const data = yield (_a7 = __classPrivateFieldGet43(this, _OAuth_session, "f").cache) === null || _a7 === void 0 ? void 0 : _a7.get("youtubei_oauth_credentials");
    if (!data)
      return false;
    const decoder = new TextDecoder();
  ...
  return __awaiter34(this, void 0, void 0, function* () {
    __classPrivateFieldSet37(this, _OAuth_identity, yield __classPrivateFieldGet43(this, _OAuth_instances, "m", _OAuth_getClientIdentity).call(this), "f");
    const data = {
      client_id: __classPrivateFieldGet43(this, _OAuth_identity, "f").client_id,
      scope: Constants_default.OAUTH.SCOPE,
      device_id: Platform.shim.uuidv4(),
      model_name: Constants_default.OAUTH.MODEL_NAME
    };
    const response = yield __classPrivateFieldGet43(this, _OAuth_session, "f").http.fetch_function(new URL("/o/oauth2/device/code", Constants_default.URLS.YT_BASE), {
      body: JSON.stringify(data),
      method: "POST",
      headers: {
        "Content-Type": "application/json"
    ...
    __classPrivateFieldGet43(this, _OAuth_session, "f").emit("auth-pending", response_data);
    __classPrivateFieldSet37(this, _OAuth_polling_interval, response_data.interval, "f");
    __classPrivateFieldGet43(this, _OAuth_instances, "m", _OAuth_startPolling).call(this, response_data.device_code);
  });
  ...
  const poller = setInterval(() => __awaiter34(this, void 0, void 0, function* () {
    const data = Object.assign(Object.assign({}, __classPrivateFieldGet43(this, _OAuth_identity, "f")), { code: device_code, grant_type: Constants_default.OAUTH.GRANT_TYPE });
    try {
      const response = yield __classPrivateFieldGet43(this, _OAuth_session, "f").http.fetch_function(new URL("/o/oauth2/token", Constants_default.URLS.YT_BASE), {
        body: JSON.stringify(data),
        method: "POST",
        headers: {
          "Content-Type": "application/json"
      ...
      if (response_data.error) {
        switch (response_data.error) {
          case "access_denied":
            __classPrivateFieldGet43(this, _OAuth_session, "f").emit("auth-error", new OAuthError("Access was denied.", { status: "ACCESS_DENIED" }));
            break;
          case "expired_token":
            __classPrivateFieldGet43(this, _OAuth_session, "f").emit("auth-error", new OAuthError("The device code has expired, restarting auth flow.", { status: "DEVICE_CODE_EXPIRED" }));
            clearInterval(poller);
            __classPrivateFieldGet43(this, _OAuth_instances, "m", _OAuth_getUserCode).call(this);
            break;
          default:
            break;
        }
      ...
      clearInterval(poller);
      return __classPrivateFieldGet43(this, _OAuth_session, "f").emit("auth-error", new OAuthError("Could not obtain user code.", { status: "FAILED", error: err }));
    }
  }), __classPrivateFieldGet43(this, _OAuth_polling_interval, "f") * 1e3);
}, "_OAuth_startPolling"), _OAuth_refreshAccessToken = /* @__PURE__ */ __name(function _OAuth_refreshAccessToken2() {
  return __awaiter34(this, void 0, void 0, function* () {
    if (!__classPrivateFieldGet43(this, _OAuth_credentials, "f"))
      return;
    __classPrivateFieldSet37(this, _OAuth_identity, yield __classPrivateFieldGet43(this, _OAuth_instances, "m", _OAuth_getClientIdentity).call(this), "f");
    const data = Object.assign(Object.assign({}, __classPrivateFieldGet43(this, _OAuth_identity, "f")), { refresh_token: __classPrivateFieldGet43(this, _OAuth_credentials, "f").refresh_token, grant_type: "refresh_token" });
    const response = yield __classPrivateFieldGet43(this, _OAuth_session, "f").http.fetch_function(new URL("/o/oauth2/token", Constants_default.URLS.YT_BASE), {
      body: JSON.stringify(data),
      method: "POST",
      headers: {
    ...
    __classPrivateFieldSet37(this, _OAuth_credentials, {
      access_token: response_data.access_token,
      refresh_token: response_data.refresh_token || __classPrivateFieldGet43(this, _OAuth_credentials, "f").refresh_token,
      expires: expiration_date
    }, "f");
    __classPrivateFieldGet43(this, _OAuth_session, "f").emit("update-credentials", {
      credentials: __classPrivateFieldGet43(this, _OAuth_credentials, "f"),
      status: "SUCCESS"
    });
  });
  ...
  var _a7;
  return __awaiter34(this, void 0, void 0, function* () {
    const response = yield __classPrivateFieldGet43(this, _OAuth_session, "f").http.fetch_function(new URL("/tv", Constants_default.URLS.YT_BASE), { headers: Constants_default.OAUTH.HEADERS });
    const response_data = yield response.text();
    const url_body = (_a7 = Constants_default.OAUTH.REGEX.AUTH_SCRIPT.exec(response_data)) === null || _a7 === void 0 ? void 0 : _a7[1];
    if (!url_body)
      throw new OAuthError("Could not obtain script url.", { status: "FAILED" });
    const script = yield __classPrivateFieldGet43(this, _OAuth_session, "f").http.fetch(url_body, { baseURL: Constants_default.URLS.YT_BASE });
...
var Session = class extends EventEmitterLike {
  ...
  static getSessionData(lang = "", location = "", account_index = 0, visitor_data = "", enable_safety_mode = false, generate_session_locally = false, device_category = "desktop", client_name = ClientType.WEB, tz = Intl.DateTimeFormat().resolvedOptions().timeZone, fetch = Platform.shim.fetch) {
    return __awaiter35(this, void 0, void 0, function* () {
      ...
      if (generate_session_locally) {
        session_data = __classPrivateFieldGet44(this, _a5, "m", _Session_generateSessionData).call(this, { lang, location, time_zone: tz, device_category, client_name, enable_safety_mode, visitor_data });
      } else {
        session_data = yield __classPrivateFieldGet44(this, _a5, "m", _Session_retrieveSessionData).call(this, { lang, location, time_zone: tz, device_category, client_name, enable_safety_mode, visitor_data }, fetch);
      }
  ...
  get key() {
    return __classPrivateFieldGet44(this, _Session_key, "f");
  }
  get api_version() {
    return __classPrivateFieldGet44(this, _Session_api_version, "f");
  }
  get client_version() {
    return __classPrivateFieldGet44(this, _Session_context, "f").client.clientVersion;
  }
  get client_name() {
    return __classPrivateFieldGet44(this, _Session_context, "f").client.clientName;
  }
  get account_index() {
    return __classPrivateFieldGet44(this, _Session_account_index, "f");
  }
  get context() {
    return __classPrivateFieldGet44(this, _Session_context, "f");
  }
  get player() {
    return __classPrivateFieldGet44(this, _Session_player, "f");
  }
  get lang() {
    return __classPrivateFieldGet44(this, _Session_context, "f").client.hl;
  }
};
...
_a5 = Session, _Session_api_version = /* @__PURE__ */ new WeakMap(), _Session_key = /* @__PURE__ */ new WeakMap(), _Session_context = /* @__PURE__ */ new WeakMap(), _Session_account_index = /* @__PURE__ */ new WeakMap(), _Session_player = /* @__PURE__ */ new WeakMap(), _Session_retrieveSessionData = /* @__PURE__ */ __name(function _Session_retrieveSessionData2(options, fetch = Platform.shim.fetch) {
  return __awaiter35(this, void 0, void 0, function* () {
    ...
    let visitor_id = Constants_default.CLIENTS.WEB.STATIC_VISITOR_ID;
...
var AccountManager = class {
  constructor(actions) {
    ...
    this.channel = {
      editName: (new_name) => {
        if (!__classPrivateFieldGet45(this, _AccountManager_actions, "f").session.logged_in)
          throw new InnertubeError("You must be signed in to perform this operation.");
        return __classPrivateFieldGet45(this, _AccountManager_actions, "f").execute("/channel/edit_name", {
          givenName: new_name,
          client: "ANDROID"
        });
      },
      editDescription: (new_description) => {
        if (!__classPrivateFieldGet45(this, _AccountManager_actions, "f").session.logged_in)
          throw new InnertubeError("You must be signed in to perform this operation.");
        return __classPrivateFieldGet45(this, _AccountManager_actions, "f").execute("/channel/edit_description", {
  ...
  getInfo() {
    return __awaiter37(this, void 0, void 0, function* () {
      if (!__classPrivateFieldGet45(this, _AccountManager_actions, "f").session.logged_in)
        throw new InnertubeError("You must be signed in to perform this operation.");
      const response = yield __classPrivateFieldGet45(this, _AccountManager_actions, "f").execute("/account/accounts_list", { client: "ANDROID" });
      return new AccountInfo_default(response);
    });
  }
  getTimeWatched() {
    return __awaiter37(this, void 0, void 0, function* () {
      const response = yield __classPrivateFieldGet45(this, _AccountManager_actions, "f").execute("/browse", {
  ...
  getSettings() {
    return __awaiter37(this, void 0, void 0, function* () {
      ...
      return new Settings_default(__classPrivateFieldGet45(this, _AccountManager_actions, "f"), response);
    });
  }
  getAnalytics() {
    var _a7;
    return __awaiter37(this, void 0, void 0, function* () {
      ...
      const params = proto_default.encodeChannelAnalyticsParams((_a7 = info.footers) === null || _a7 === void 0 ? void 0 : _a7.endpoint.payload.browseId);
      const response = yield __classPrivateFieldGet45(this, _AccountManager_actions, "f").execute("/browse", {
...
var InteractionManager = class {
  ...
  like(video_id) {
    return __awaiter38(this, void 0, void 0, function* () {
      ...
      if (!__classPrivateFieldGet46(this, _InteractionManager_actions, "f").session.logged_in)
        throw new Error("You must be signed in to perform this operation.");
      const action = yield __classPrivateFieldGet46(this, _InteractionManager_actions, "f").execute("/like/like", {
        client: "ANDROID",
        target: {
          videoId: video_id
        }
  ...
  dislike(video_id) {
    return __awaiter38(this, void 0, void 0, function* () {
      ...
      if (!__classPrivateFieldGet46(this, _InteractionManager_actions, "f").session.logged_in)
        throw new Error("You must be signed in to perform this operation.");
      const action = yield __classPrivateFieldGet46(this, _InteractionManager_actions, "f").execute("/like/dislike", {
        client: "ANDROID",
        target: {
          videoId: video_id
        }
  ...
  removeRating(video_id) {
    return __awaiter38(this, void 0, void 0, function* () {
      ...
      if (!__classPrivateFieldGet46(this, _InteractionManager_actions, "f").session.logged_in)
        throw new Error("You must be signed in to perform this operation.");
      const action = yield __classPrivateFieldGet46(this, _InteractionManager_actions, "f").execute("/like/removelike", {
        client: "ANDROID",
        target: {
          videoId: video_id
        }
  ...
  subscribe(channel_id) {
    return __awaiter38(this, void 0, void 0, function* () {
      ...
      if (!__classPrivateFieldGet46(this, _InteractionManager_actions, "f").session.logged_in)
        throw new Error("You must be signed in to perform this operation.");
      const action = yield __classPrivateFieldGet46(this, _InteractionManager_actions, "f").execute("/subscription/subscribe", {
        client: "ANDROID",
  ...
  unsubscribe(channel_id) {
    return __awaiter38(this, void 0, void 0, function* () {
      ...
      if (!__classPrivateFieldGet46(this, _InteractionManager_actions, "f").session.logged_in)
        throw new Error("You must be signed in to perform this operation.");
      const action = yield __classPrivateFieldGet46(this, _InteractionManager_actions, "f").execute("/subscription/unsubscribe", {
        client: "ANDROID",
        channelIds: [channel_id],
        params: "CgIIAhgA"
      });
  ...
  comment(video_id, text) {
    return __awaiter38(this, void 0, void 0, function* () {
      ...
      if (!__classPrivateFieldGet46(this, _InteractionManager_actions, "f").session.logged_in)
        throw new Error("You must be signed in to perform this operation.");
      const action = yield __classPrivateFieldGet46(this, _InteractionManager_actions, "f").execute("/comment/create_comment", {
        client: "ANDROID",
        commentText: text,
  ...
  translate(text, target_language, args = {}) {
    return __awaiter38(this, void 0, void 0, function* () {
      ...
      const response = yield __classPrivateFieldGet46(this, _InteractionManager_actions, "f").execute("/comment/perform_comment_action", {
        client: "ANDROID",
  ...
  setNotificationPreferences(channel_id, type) {
    return __awaiter38(this, void 0, void 0, function* () {
      ...
      const action = yield __classPrivateFieldGet46(this, _InteractionManager_actions, "f").execute("/notification/modify_channel_preference", {
        client: "WEB",
...
var Kids = class {
  ...
  search(query) {
    return __awaiter39(this, void 0, void 0, function* () {
      const response = yield __classPrivateFieldGet47(this, _Kids_session, "f").actions.execute("/search", { query, client: "YTKIDS" });
      return new Search_default2(__classPrivateFieldGet47(this, _Kids_session, "f").actions, response);
    });
  }
  getInfo(video_id) {
    var _a7;
    return __awaiter39(this, void 0, void 0, function* () {
      ...
      const initial_info = __classPrivateFieldGet47(this, _Kids_session, "f").actions.execute("/player", {
        cpn,
        client: "YTKIDS",
        videoId: video_id,
        playbackContext: {
          contentPlaybackContext: {
            signatureTimestamp: ((_a7 = __classPrivateFieldGet47(this, _Kids_session, "f").player) === null || _a7 === void 0 ? void 0 : _a7.sts) || 0
          }
        }
      });
      const continuation = __classPrivateFieldGet47(this, _Kids_session, "f").actions.execute("/next", { videoId: video_id, client: "YTKIDS" });
      const response = yield Promise.all([initial_info, continuation]);
      return new VideoInfo_default2(response, __classPrivateFieldGet47(this, _Kids_session, "f").actions, cpn);
    });
  }
  getChannel(channel_id) {
    return __awaiter39(this, void 0, void 0, function* () {
      const response = yield __classPrivateFieldGet47(this, _Kids_session, "f").actions.execute("/browse", { browseId: channel_id, client: "YTKIDS" });
      return new Channel_default2(__classPrivateFieldGet47(this, _Kids_session, "f").actions, response);
    });
  }
  getHomeFeed() {
    return __awaiter39(this, void 0, void 0, function* () {
      const response = yield __classPrivateFieldGet47(this, _Kids_session, "f").actions.execute("/browse", { browseId: "FEkids_home", client: "YTKIDS" });
      return new HomeFeed_default2(__classPrivateFieldGet47(this, _Kids_session, "f").actions, response);
    });
  }
};
__name(Kids, "Kids");
...
var Music = class {
  ...
  getInfo(target) {
    if (target instanceof MusicTwoRowItem_default) {
      return __classPrivateFieldGet48(this, _Music_instances, "m", _Music_fetchInfoFromListItem).call(this, target);
    } else if (typeof target === "string") {
      return __classPrivateFieldGet48(this, _Music_instances, "m", _Music_fetchInfoFromVideoId).call(this, target);
    }
  ...
  search(query, filters = {}) {
    return __awaiter40(this, void 0, void 0, function* () {
      ...
      const response = yield __classPrivateFieldGet48(this, _Music_actions, "f").execute("/search", payload);
      return new Search2(response, __classPrivateFieldGet48(this, _Music_actions, "f"), Reflect.has(filters, "type") && filters.type !== "all");
    });
  }
  getHomeFeed() {
    return __awaiter40(this, void 0, void 0, function* () {
      const response = yield __classPrivateFieldGet48(this, _Music_actions, "f").execute("/browse", {
        client: "YTMUSIC",
        browseId: "FEmusic_home"
      });
      return new HomeFeed_default(response, __classPrivateFieldGet48(this, _Music_actions, "f"));
    });
  }
  getExplore() {
    return __awaiter40(this, void 0, void 0, function* () {
  ...
  getLibrary() {
    return __awaiter40(this, void 0, void 0, function* () {
      ...
      return new Library_default2(response, __classPrivateFieldGet48(this, _Music_actions, "f"));
    });
  }
  getArtist(artist_id) {
    return __awaiter40(this, void 0, void 0, function* () {
      ...
      return new Artist_default(response, __classPrivateFieldGet48(this, _Music_actions, "f"));
    });
  }
  getAlbum(album_id) {
    return __awaiter40(this, void 0, void 0, function* () {
  ...
  getPlaylist(playlist_id) {
    return __awaiter40(this, void 0, void 0, function* () {
      ...
      return new Playlist_default3(response, __classPrivateFieldGet48(this, _Music_actions, "f"));
    });
  }
  getUpNext(video_id, automix = true) {
    ...
    return __awaiter40(this, void 0, void 0, function* () {
      throwIfMissing({ video_id });
      const data = yield __classPrivateFieldGet48(this, _Music_actions, "f").execute("/next", {
        videoId: video_id,
        client: "YTMUSIC",
        parse: true
      });
      const tabs = (_a7 = data.contents_memo) === null || _a7 === void 0 ? void 0 : _a7.getType(Tab_default);
      ...
      if (!playlist_panel.playlist_id && automix) {
        ...
        if (!automix_preview_video)
          throw new InnertubeError("Automix item not found");
        const page = yield (_c = automix_preview_video.playlist_video) === null || _c === void 0 ? void 0 : _c.endpoint.call(__classPrivateFieldGet48(this, _Music_actions, "f"), {
          videoId: video_id,
          client: "YTMUSIC",
          parse: true
        });
  ...
  getRelated(video_id) {
    ...
    return __awaiter40(this, void 0, void 0, function* () {
      ...
      if (!tab)
        throw new InnertubeError("Could not find target tab.");
      const page = yield tab.endpoint.call(__classPrivateFieldGet48(this, _Music_actions, "f"), { client: "YTMUSIC", parse: true });
      if (!page.contents)
  ...
  getRecap() {
    return __awaiter40(this, void 0, void 0, function* () {
      ...
      return new Recap_default(response, __classPrivateFieldGet48(this, _Music_actions, "f"));
    });
  }
  getSearchSuggestions(query) {
    var _a7, _b2;
    return __awaiter40(this, void 0, void 0, function* () {
      const response = yield __classPrivateFieldGet48(this, _Music_actions, "f").execute("/music/get_search_suggestions", {
        parse: true,
        input: query,
        client: "YTMUSIC"
      });
      const search_suggestions_section = (_b2 = (_a7 = response.contents_memo) === null || _a7 === void 0 ? void 0 : _a7.getType(SearchSuggestionsSection_default)) === null || _b2 === void 0 ? void 0 : _b2[0];
...
_Music_session = /* @__PURE__ */ new WeakMap(), _Music_actions = /* @__PURE__ */ new WeakMap(), _Music_instances = /* @__PURE__ */ new WeakSet(), _Music_fetchInfoFromVideoId = /* @__PURE__ */ __name(function _Music_fetchInfoFromVideoId2(video_id) {
  ...
  return __awaiter40(this, void 0, void 0, function* () {
    const cpn = generateRandomString(16);
    const initial_info = __classPrivateFieldGet48(this, _Music_actions, "f").execute("/player", {
      cpn,
      client: "YTMUSIC",
      videoId: video_id,
      playbackContext: {
        contentPlaybackContext: {
          signatureTimestamp: ((_a7 = __classPrivateFieldGet48(this, _Music_session, "f").player) === null || _a7 === void 0 ? void 0 : _a7.sts) || 0
        }
      }
    });
    const continuation = __classPrivateFieldGet48(this, _Music_actions, "f").execute("/next", {
      client: "YTMUSIC",
      videoId: video_id
    });
    const response = yield Promise.all([initial_info, continuation]);
    return new TrackInfo_default(response, __classPrivateFieldGet48(this, _Music_actions, "f"), cpn);
  });
  ...
  return __awaiter40(this, void 0, void 0, function* () {
    ...
    const cpn = generateRandomString(16);
    const initial_info = list_item.endpoint.call(__classPrivateFieldGet48(this, _Music_actions, "f"), {
      cpn,
      client: "YTMUSIC",
      playbackContext: {
        contentPlaybackContext: {
    ...
    const continuation = list_item.endpoint.call(__classPrivateFieldGet48(this, _Music_actions, "f"), {
      client: "YTMUSIC",
...
var PlaylistManager = class {
  ...
  create(title, video_ids) {
    return __awaiter41(this, void 0, void 0, function* () {
      ...
      if (!__classPrivateFieldGet49(this, _PlaylistManager_actions, "f").session.logged_in)
        throw new InnertubeError("You must be signed in to perform this operation.");
      const response = yield __classPrivateFieldGet49(this, _PlaylistManager_actions, "f").execute("/playlist/create", {
        title,
        ids: video_ids,
        parse: false
      });
  ...
  delete(playlist_id) {
    return __awaiter41(this, void 0, void 0, function* () {
      ...
      if (!__classPrivateFieldGet49(this, _PlaylistManager_actions, "f").session.logged_in)
        throw new InnertubeError("You must be signed in to perform this operation.");
      const response = yield __classPrivateFieldGet49(this, _PlaylistManager_actions, "f").execute("playlist/delete", { playlistId: playlist_id });
      return {
        playlist_id,
        success: response.success,
        status_code: response.status_code,
  ...
  addVideos(playlist_id, video_ids) {
    return __awaiter41(this, void 0, void 0, function* () {
      ...
      if (!__classPrivateFieldGet49(this, _PlaylistManager_actions, "f").session.logged_in)
        throw new InnertubeError("You must be signed in to perform this operation.");
      const response = yield __classPrivateFieldGet49(this, _PlaylistManager_actions, "f").execute("/browse/edit_playlist", {
  ...
  removeVideos(playlist_id, video_ids) {
    return __awaiter41(this, void 0, void 0, function* () {
      ...
      if (!__classPrivateFieldGet49(this, _PlaylistManager_actions, "f").session.logged_in)
        throw new InnertubeError("You must be signed in to perform this operation.");
      const info = yield __classPrivateFieldGet49(this, _PlaylistManager_actions, "f").execute("/browse", {
        browseId: `VL${playlist_id}`,
        parse: true
      });
      const playlist = new Playlist_default2(__classPrivateFieldGet49(this, _PlaylistManager_actions, "f"), info, true);
      ...
      const response = yield __classPrivateFieldGet49(this, _PlaylistManager_actions, "f").execute("/browse/edit_playlist", Object.assign(Object.assign({}, payload), { parse: false }));
      return {
        playlist_id,
        action_result: response.data.actions
      };
...
var Studio = class {
  ...
  setThumbnail(video_id, buffer) {
    return __awaiter42(this, void 0, void 0, function* () {
      if (!__classPrivateFieldGet50(this, _Studio_session, "f").logged_in)
        throw new InnertubeError("You must be signed in to perform this operation.");
      if (!video_id || !buffer)
      ...
      const response = yield __classPrivateFieldGet50(this, _Studio_session, "f").actions.execute("/video_manager/metadata_update", {
        protobuf: true,
  ...
  upload(file, metadata = {}) {
    return __awaiter42(this, void 0, void 0, function* () {
      if (!__classPrivateFieldGet50(this, _Studio_session, "f").logged_in)
        throw new InnertubeError("You must be signed in to perform this operation.");
      const initial_data = yield __classPrivateFieldGet50(this, _Studio_instances, "m", _Studio_getInitialUploadData).call(this);
      const upload_result = yield __classPrivateFieldGet50(this, _Studio_instances, "m", _Studio_uploadVideo).call(this, initial_data.upload_url, file);
      if (upload_result.status !== "STATUS_SUCCESS")
        throw new InnertubeError("Could not process video.");
      const response = yield __classPrivateFieldGet50(this, _Studio_instances, "m", _Studio_setVideoMetadata).call(this, initial_data, upload_result, metadata);
      return response;
    });
  }
};
...
_Studio_session = /* @__PURE__ */ new WeakMap(), _Studio_instances = /* @__PURE__ */ new WeakSet(), _Studio_getInitialUploadData = /* @__PURE__ */ __name(function _Studio_getInitialUploadData2() {
  return __awaiter42(this, void 0, void 0, function* () {
    ...
    const response = yield __classPrivateFieldGet50(this, _Studio_session, "f").http.fetch("/upload/youtubei", {
  ...
  return __awaiter42(this, void 0, void 0, function* () {
    const response = yield __classPrivateFieldGet50(this, _Studio_session, "f").http.fetch_function(upload_url, {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
  ...
  return __awaiter42(this, void 0, void 0, function* () {
    ...
    const response = yield __classPrivateFieldGet50(this, _Studio_session, "f").actions.execute("/upload/createvideo", Object.assign({ client: "ANDROID" }, metadata_payload));
    return response;
  });
...
var Guide = class {
  constructor(data) {
    ...
    this.contents = __classPrivateFieldGet51(this, _Guide_page, "f").items.array().as(GuideSection_default, GuideSubscriptionsSection_default);
  }
  get page() {
    return __classPrivateFieldGet51(this, _Guide_page, "f");
  }
};
__name(Guide, "Guide");
...
var __classPrivateFieldGet52 = function(receiver, state, kind, f) {
  if (kind === "a" && !f)
    throw new TypeError("Private accessor was defined without a getter");
  if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver))
    throw new TypeError("Cannot read private member from an object whose class did not declare it");
...
var Innertube = class {
  constructor(session) {
    ...
    __classPrivateFieldSet46(this, _Innertube_session, session, "f");
  }
  ...
  getInfo(target, client) {
    ...
    return __awaiter43(this, void 0, void 0, function* () {
      ...
      if (target instanceof NavigationEndpoint_default) {
        const video_id = (_a7 = target.payload) === null || _a7 === void 0 ? void 0 : _a7.videoId;
        if (!video_id)
  ...
  getSearchSuggestions(query) {
    return __awaiter43(this, void 0, void 0, function* () {
      ...
      url.searchParams.set("hl", __classPrivateFieldGet52(this, _Innertube_session, "f").context.client.hl);
      url.searchParams.set("gl", __classPrivateFieldGet52(this, _Innertube_session, "f").context.client.gl);
      url.searchParams.set("ds", "yt");
      url.searchParams.set("client", "youtube");
      url.searchParams.set("xssi", "t");
      url.searchParams.set("oe", "UTF");
      const response = yield __classPrivateFieldGet52(this, _Innertube_session, "f").http.fetch(url);
      const response_data = yield response.text();
  ...
  get music() {
    return new Music_default(__classPrivateFieldGet52(this, _Innertube_session, "f"));
  }
  get studio() {
    return new Studio_default(__classPrivateFieldGet52(this, _Innertube_session, "f"));
  }
  get kids() {
    return new Kids_default(__classPrivateFieldGet52(this, _Innertube_session, "f"));
  }
  get account() {
    return new AccountManager_default(__classPrivateFieldGet52(this, _Innertube_session, "f").actions);
  }
  get playlist() {
    return new PlaylistManager_default(__classPrivateFieldGet52(this, _Innertube_session, "f").actions);
  }
  get interact() {
    return new InteractionManager_default(__classPrivateFieldGet52(this, _Innertube_session, "f").actions);
  }
  get actions() {
    return __classPrivateFieldGet52(this, _Innertube_session, "f").actions;
  }
  get session() {
    return __classPrivateFieldGet52(this, _Innertube_session, "f");
  }
};
...
var __classPrivateFieldSet47 = function(receiver, state, value, kind, f) {
  if (kind === "m")
    throw new TypeError("Private method is not writable");
  if (kind === "a" && !f)
    throw new TypeError("Private accessor was defined without a setter");
...
var __classPrivateFieldGet53 = function(receiver, state, kind, f) {
  if (kind === "a" && !f)
    throw new TypeError("Private accessor was defined without a getter");
  if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver))
    throw new TypeError("Cannot read private member from an object whose class did not declare it");
...
var Cache = class {
  constructor(persistent = false, persistent_directory) {
    ...
    __classPrivateFieldSet47(this, _Cache_persistent_directory, persistent_directory || Cache.default_persistent_directory, "f");
    __classPrivateFieldSet47(this, _Cache_persistent, persistent, "f");
  }
  ...
  get cache_dir() {
    return __classPrivateFieldGet53(this, _Cache_persistent, "f") ? __classPrivateFieldGet53(this, _Cache_persistent_directory, "f") : Cache.temp_directory;
  }
  get(key) {
    return __awaiter44(this, void 0, void 0, function* () {
      yield __classPrivateFieldGet53(this, _Cache_instances, "m", _Cache_createCache).call(this);
...
Platform.load({
  ...
  server: true,
  Cache,
  sha1Hash: (data) => __awaiter44(void 0, void 0, void 0, function* () {
